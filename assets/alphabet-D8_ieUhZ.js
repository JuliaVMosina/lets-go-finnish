...
import{f as e,i as t,l as n,m as r,p as i,u as a}from"./index-BYjmFR7j.js";var o=null,s=null,c=null,l=0,u=0;function d(){return document.querySelector(`#app`)}function f(e){return o=e,s=n[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=t(),a.exerciseStart?.(e.id,`alphabet`),m()}function p(){h()}function m(){let{color:e,bg:t}=s,n=new Set(c.special),r=c.letters.map(e=>`
    ...
    </div>`}function h(){document.getElementById(`ab-back`)?.addEventListener(`click`,()=>{e(()=>import(`./index-BYjmFR7j.js`).then(e=>e.t).then(e=>{d().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))});let t=document.getElementById(`ab-audio`),n=document.getElementById(`ab-play`),r=!1;n?.addEventListener(`click`,()=>{t&&(r?(t.pause(),t.currentTime=0,n.textContent=`▶ Слушать алфавит`,r=!1):(t.play().catch(()=>{}),n.textContent=`⏹ Остановить`,r=!0))}),t?.addEventListener(`ended`,()=>{n.textContent=`▶ Слушать алфавит`,r=!1}),document.getElementById(`ab-start-quiz`)?.addEventListener(`click`,()=>{l=0,u=0,g()})}function g(){let e=c.quiz;if(l>=e.length){_();return}let t=e[l],{color:n,bg:r}=s,i=[...t.options].sort(()=>Math.random()-.5);d().innerHTML=`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`,document.getElementById(`ab-done-back`)?.addEventListener(`click`,()=>{d().innerHTML=m(),h()}),document.getElementById(`ab-retry`)?.addEventListener(`click`,()=>{l=0,u=0,g()}),document.getElementById(`ab-to-hub`)?.addEventListener(`click`,()=>{e(()=>import(`./index-BYjmFR7j.js`).then(e=>e.t).then(e=>{d().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))})}export{p as bindAlphabetPage,f as renderAlphabetPage};
...
import{a as e,c as t,d as n,l as r,s as i,u as a}from"./index-0GnRsfCI.js";function o(e){return e===`puhekieli`?`<span class="reg-badge reg-puhe">💬 puhekieli</span>`:e===`kirjakieli`?`<span class="reg-badge reg-kirja">📖 kirjakieli</span>`:``}var s=null,c=null,l=[],u=0,d=0,f=!1;function p(){return document.querySelector(`#app`)}function m(t){return s=t,c=i[t.id]||{color:`#7C3AED`,bg:`#EDE7FB`},l=e(t.id),u=0,d=0,g()}function h(){_()}function g(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function _(){document.getElementById(`ls-back-list`)?.addEventListener(`click`,()=>{r(()=>import(`./index-0GnRsfCI.js`).then(e=>e.t).then(e=>{p().innerHTML=e.renderExercisesPage(s,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.ls-track-card`).forEach(e=>{e.addEventListener(`click`,()=>{u=+e.dataset.i,d=0,f=!1,t.listeningStart(s.id,l[u].id),v()})})}function v(){let e=l[u];y(e,0)}function y(e,t){let n=e.questions[t],r=t===e.questions.length-1,i=Math.round(t/e.questions.length*100);p().innerHTML=`
    <div class="ex-page">
      <header class="header">

...
`,`"`,s.BYTE_ORDER_MARK],s.WORKERS_SUPPORTED=!r&&!!t.Worker,s.NODE_STREAM_INPUT=1,s.LocalChunkSize=10485760,s.RemoteChunkSize=5242880,s.DefaultDelimiter=`,`,s.Parser=h,s.ParserHandle=p,s.NetworkStreamer=l,s.FileStreamer=u,s.StringStreamer=d,s.ReadableStreamStreamer=f,t.jQuery&&((n=t.jQuery).fn.parse=function(e){var r=e.config||{},i=[];return this.each(function(e){if(!(n(this).prop(`tagName`).toUpperCase()===`INPUT`&&n(this).attr(`type`).toLowerCase()===`file`&&t.FileReader)||!this.files||this.files.length===0)return!0;for(var a=0;a<this.files.length;a++)i.push({file:this.files[a],inputElem:this,instanceConfig:n.extend({},r)})}),a(),this;function a(){if(i.length===0)x(e.complete)&&e.complete();else{var t,r,a,c,l=i[0];if(x(e.before)){var u=e.before(l.file,l.inputElem);if(typeof u==`object`){if(u.action===`abort`)return t=`AbortError`,r=l.file,a=l.inputElem,c=u.reason,void(x(e.error)&&e.error({name:t},r,a,c));if(u.action===`skip`)return void o();typeof u.config==`object`&&(l.instanceConfig=n.extend(l.instanceConfig,u.config))}else if(u===`skip`)return void o()}var d=l.instanceConfig.complete;l.instanceConfig.complete=function(e){x(d)&&d(e,l.file,l.inputElem),o()},s.parse(l.file,l.instanceConfig)}}function o(){i.splice(0,1),a()}}),i&&(t.onmessage=function(e){e=e.data,s.WORKER_ID===void 0&&e&&(s.WORKER_ID=e.workerId),typeof e.input==`string`?t.postMessage({workerId:s.WORKER_ID,results:s.parse(e.input,e.config),finished:!0}):(t.File&&e.input instanceof File||e.input instanceof Object)&&(e=s.parse(e.input,e.config))&&t.postMessage({workerId:s.WORKER_ID,results:e,finished:!0})}),(l.prototype=Object.create(c.prototype)).constructor=l,(u.prototype=Object.create(c.prototype)).constructor=u,(d.prototype=Object.create(d.prototype)).constructor=d,(f.prototype=Object.create(c.prototype)).constructor=f,s})}))(),1),te=`2PACX-1vQwqkX44b-HPNysrWI2Qy5AtbUv9DVW8JtDXiFBvoe7lkIbkp-TNP2VjLyli2AUzFFCHZH0HYvcfytH`,E={chapters:`0`,vocabulary:`195278083`,exercises:`1198814770`,grammar:`877359757`};function D(e){return`https://docs.google.com/spreadsheets/d/e/${te}/pub?gid=${e}&single=true&output=csv`}async function O(e){let t=await(await fetch(D(e))).text();return ee.default.parse(t,{header:!0,skipEmptyLines:!0}).data}async function ne(){let[e,t,n,r]=await Promise.all([O(E.chapters),O(E.vocabulary),O(E.exercises),O(E.grammar)]);return{chapters:e,vocabulary:t,exercises:n,grammar:r}}function k(){let e=(location.hash.replace(`#`,``)||`/`).split(`/`).filter(Boolean);return e.length===0?{page:`dashboard`}:e[0]===`chapter`&&e[1]?{page:e[2]||`chapter`,chapterId:e[1],section:e[2]||null}:e[0]===`profile`&&e[1]?{page:`profile`,profileId:e[1]}:{page:`dashboard`}}function A(e){location.hash=e}function j(e){window.addEventListener(`hashchange`,e)}var re={ch1:{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},ch2:{color:`#EC4899`,bg:`#FAE9F2`,img:`ch2.png`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`,img:`ch3.png`},ch4:{color:`#10B981`,bg:`#E8F7EE`,img:`ch4.png`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`,img:`ch5.png`}};function M(e,t,n,r){let i=e[n]?.[t]||{},a=Object.values(i).filter(e=>e.completed||e.seen).length;return r>0?Math.round(a/r*100):0}var ie={ch1:`👋 К концу этой главы ты сможешь поздороваться, представиться и назвать день недели — по-фински. Это твои первые живые слова!`};function N(e,t,n,r,i=[]){let a=g(),o=re[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},s=M(a,e.id,`vocabulary`,t.length),c=M(a,e.id,`exercises`,n.length),l=i.length,u=a.grammarProgress?.[e.id]||{},d=Object.values(u).filter(e=>e===!0).length,f=l>0?Math.round(d/l*100):0,p=Math.round((s+f+c)/3),m=ie[e.id];return`
  ...
  `}function P(e,t,n){document.getElementById(`btn-back`)?.addEventListener(`click`,()=>{A(`/`)});let r=C(n,e,t.length),i=document.getElementById(`vocab-meta`);i&&(i.textContent=`выучено ${r.known} / ${t.length}`),document.querySelectorAll(`.section-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.section;A(`/chapter/${e}/${n}`)})})}var ae={ch1:{color:`#7C3AED`,bg:`#EDE7FB`},ch2:{color:`#EC4899`,bg:`#FAE9F2`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`},ch4:{color:`#10B981`,bg:`#E8F7EE`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`}},F=0,I=[],L=[],R=null,z=null,B=!1,oe=null,V=[],H=null,se={приветствия:`👋`,числа:`🔢`,"дни недели":`📅`,месяцы:`🗓️`,"времена года":`🍂`,погода:`⛅`,семья:`👨‍👩‍👧‍👦`,одежда:`👕`,цвета:`🎨`,время:`⏰`};function ce(e){let t={};return e.forEach((e,n)=>{let r=e.category||R.id;t[r]||(t[r]=[]),t[r].push({...e,_origIndex:n})}),t}function le(){let e=p(),t=x(e.activeProfile,R.id),n=S(e.activeProfile,R.id),r=Object.keys(n).length>0,i=t&&!t.category?t:null;if(!i&&!r)return`
    ...
    <div class="mode-card" id="mode-test">
      <div class="mode-icon" style="background: ${i?.pct>=80?`#F0FDF4`:z.bg}">${s}</div>
      <div class="mode-info">
        <div class="mode-name">Тест</div>
        ${a}
        ${o}
  ...
  `}function ue(e,t){return R=e,I=t,L=t,R._allWords=t,z=ae[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},`<div class="vocab-page">${U()}</div>`}function W(e){R=e,R._allWords||=L,z=ae[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-vocab`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}`)}),document.getElementById(`mode-flashcard`)?.addEventListener(`click`,()=>de(`flashcard`)),document.getElementById(`mode-test`)?.addEventListener(`click`,()=>de(`test`)),document.getElementById(`mode-hard`)?.addEventListener(`click`,()=>fe(!0))}function de(e){oe=e;let t=ce(L),n=[`числа`,`приветствия`,`дни недели`].filter(e=>t[e]).map(e=>{let n=t[e],r=se[e]||`📚`;return`
  ...
  `;document.querySelector(`.vocab-page`).innerHTML=r,document.getElementById(`btn-back-source`)?.addEventListener(`click`,()=>{document.querySelector(`.vocab-page`).innerHTML=U(),W(R)}),document.getElementById(`source-all`)?.addEventListener(`click`,()=>{I=L,H=null,oe===`flashcard`?fe(!1):_e()}),document.querySelectorAll(`.category-card`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.category;I=t[n]||[],H=n,oe===`flashcard`?fe(!1):_e()})})}function fe(e=!1){let t=p(),n=t.activeProfile;if(e){let e=t.profiles[n]?.vocabulary[R.id]||{},r=Object.entries(e).filter(([,e])=>e.status===`hard`).map(([e])=>parseInt(e.replace(`w_`,``)));F=0,I=r.map(e=>({...I[e],_origIndex:e}))}else I=[...I].map((e,t)=>({...e,_origIndex:t})),F=w(n,R.id,I);B=!1,pe()}function pe(){let e=I[F];if(!e){ge();return}let t=p(),n=t.profiles[t.activeProfile]?.vocabulary[R.id]||{};n[`w_${e._origIndex??F}`]?.status,document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
  ...
  `,document.getElementById(`btn-back-test`)?.addEventListener(`click`,()=>{I=R._allWords||I,document.querySelector(`.vocab-page`).innerHTML=U(),W(R)}),ye(e)}function ye(e){let t=!1;document.querySelectorAll(`.test-option`).forEach(n=>{n.addEventListener(`click`,()=>{if(t)return;t=!0;let r=n.dataset.correct===`true`;r&&K++,document.querySelectorAll(`.test-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===n&&!r&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`test-feedback`);i.style.display=`flex`,i.innerHTML=r?`<div class="feedback-correct" style="border-color: ${z.color}">✓ Правильно!</div>
  ...
  `,document.getElementById(`btn-test-done`)?.addEventListener(`click`,()=>{I=R._allWords||I,document.querySelector(`.vocab-page`).innerHTML=U(),W(R)}),document.getElementById(`btn-retest`)?.addEventListener(`click`,_e),document.getElementById(`btn-to-chapter-t`)?.addEventListener(`click`,()=>A(`/chapter/${R.id}`))}var xe={ch1:{color:`#7C3AED`,bg:`#EDE7FB`},ch2:{color:`#EC4899`,bg:`#FAE9F2`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`},ch4:{color:`#10B981`,bg:`#E8F7EE`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`}},Se={multiple_choice:`☑️ Выбери правильный`,fill_blank:`✏️ Заполни пропуск`,self_check:`👁️ Самопроверка`,matching:`🔗 Соедини пары`,vowel_harmony:`🔤 Гармония гласных`},q=[],J=0,Y=null,X=null,Ce=!1;function we(e,t){return Y=e,q=t,J=0,Ce=!1,X=xe[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},q.length?`
    <div class="ex-page">
      <header class="header">
      ...
      <div class="ex-progress-bar">
        <div class="ex-progress-fill" id="ex-progress-fill"
             style="width: ${Te(0)}%; background: ${X.color}"></div>
      </div>
  ...
  `}function Oe(e){Y=e,X=xe[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}`)}),ke()}function ke(){let e=q[J];e&&(Ce=!1,document.getElementById(`btn-show-answer`)?.addEventListener(`click`,()=>{document.getElementById(`answer-reveal`).style.display=`block`,document.getElementById(`btn-show-answer`).style.display=`none`}),document.querySelectorAll(`.self-btn`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.result,v(p().activeProfile,Y.id,J,e.dataset.result),Ae()})}),document.querySelectorAll(`.ex-option`).forEach(t=>{t.addEventListener(`click`,()=>{if(Ce)return;Ce=!0;let n=t.dataset.correct===`true`,r=document.querySelector(`.ex-card`).dataset.correct;document.querySelectorAll(`.ex-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===t&&!n&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`ex-feedback`);i.style.display=`block`,i.innerHTML=n?`<div class="feedback-correct" style="border-color: ${X.color}">
           ...
           <button class="ex-next-btn" id="btn-next" style="background: ${X.color}">
             ${J+1<q.length?`Следующее →`:`Завершить 🎉`}
           </button>`,v(p().activeProfile,Y.id,J,n?`right`:`wrong`),document.getElementById(`btn-next`)?.addEventListener(`click`,Ae)})}))}function Ae(){if(J++,J>=q.length){je();return}let e=document.getElementById(`ex-container`);e.innerHTML=De(q[J],J),document.getElementById(`ex-counter`).textContent=`${J+1} / ${q.length}`,document.getElementById(`ex-progress-fill`).style.width=`${Te(J)}%`,ke()}function je(){let e=document.getElementById(`ex-container`);e.innerHTML=`
    <div class="complete-screen">
      <div class="complete-emoji">🏆</div>
  ...
  `,document.getElementById(`btn-to-chapter-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${Y.id}`)})}var Me={tervehtimiset:[{q:`Как поздороваться вечером`,a:`Iltaa`},{q:`Как сказать «Добро пожаловать»`,a:`Tervetuloa`},{q:`Как ответить на «Kiitos»`,a:`Ei kestä`},{q:`Как сказать «Ничего страшного»`,a:`Ei se mitään`},{q:`Как спросить «Как дела»`,a:`Mitä kuuluu`},{q:`Как сказать «Спокойной ночи»`,a:`Hyvää yötä`},{q:`Как сказать «До свидания» (официально)`,a:`Näkemiin`},{q:`Как сказать «Увидимся» (в разговоре)`,a:`Nähdään`},{q:`Как сказать «Пока пока» (разговорное)`,a:`Moi moi / Hei hei / Moikka`},{q:`Как попросить прощения`,a:`Anteeksi`},{q:`Как ответить на «Mitä kuuluu»`,a:`Ihan hyvää / Kiitos hyvää`}],tutustuminen:[{q:`Как сказать «Меня зовут Анна»`,a:`Mun nimi on Anna / Minun nimeni on Anna`},{q:`Как спросить «Откуда ты» по-разговорному`,a:`Mistä oot kotoisin`},{q:`Как сказать «Я из Финляндии»`,a:`Olen Suomesta`},{q:`Как сказать «Мне 28 лет»`,a:`Olen 28-vuotias`},{q:`Как сказать «Не понимаю»`,a:`En ymmärrä`},{q:`Как попросить говорить медленнее`,a:`Voitko puhua hitaammin`},{q:`Как сказать «Приятно познакомиться»`,a:`Hauska tutustua`},{q:`Как спросить «Говоришь по-английски» (вопрос)`,a:`Puhutko englantia`},{q:`Как спросить «Как тебя зовут» по-разговорному (вопрос)`,a:`Mikä sun nimi on`},{q:`Как сказать «Я из России»`,a:`Olen Venäjältä`},{q:`Как сказать «Мне нужна помощь»`,a:`Tarvitsen apua`},{q:`Как спросить «Тебе нужна помощь?» (вопрос)`,a:`Tarvitsetko apua`},{q:`Как спросить «Где ты живёшь?» (вопрос)`,a:`Missä asut`},{q:`Как спросить «Что случилось?» (вопрос)`,a:`Mitä on tapahtunut / Mitä tapahtui`},{q:`Как спросить «Как это пишется?» (вопрос)`,a:`Miten tämä kirjoitetaan`}],lauserakenne:[{q:`Как спросить «Что это» (вопрос)`,a:`Mikä tämä on`},{q:`Как сказать «Это книга»`,a:`Se on kirja`},{q:`Как сказать «Это хороший автобус»`,a:`Se on hyvä bussi`},{q:`Как сказать «Эта машина плохая»`,a:`Tämä auto on huono`},{q:`Как сказать «Это отель»`,a:`Se on hotelli`},{q:`Как спросить «Это хорошая книга?» (вопрос)`,a:`Onko se hyvä kirja`},{q:`Как спросить «Кто это?» (вопрос)`,a:`Kuka tämä on`}],persoonapronominit:[{q:`Как сказать «Вы финны»`,a:`Te olette suomalaisia / Te ootte suomalaisia`},{q:`Как сказать «Я студентка»`,a:`Minä olen opiskelija / Mä oon opiskelija`},{q:`Как сказать «Он дома»`,a:`Hän on kotona / Se on kotona`},{q:`Как сказать «Они здесь»`,a:`He ovat täällä / Ne on täällä`},{q:`Как сказать «Ты готова»`,a:`Sinä olet valmis / Sä oot valmis`},{q:`Как спросить «Ты готова?» (вопрос)`,a:`Oletko sinä valmis / Ootko sä valmis`},{q:`Как сказать «Мы учимся»`,a:`Me opiskelemme / Me opiskellaan`}],verbit:[{q:`Как сказать «Я живу в Хельсинки»`,a:`Asun Helsingissä / Mä asun Helsingissä`},{q:`Как спросить «Где ты живёшь?» (вопрос)`,a:`Missä asut`},{q:`Как сказать «Она живёт в Тампере»`,a:`Hän asuu Tampereella / Se asuu Tampereella`},{q:`Как сказать «Мы живём в Финляндии»`,a:`Me asumme Suomessa / Me asutaan Suomessa`},{q:`Как сказать «Я говорю по-фински»`,a:`Puhun suomea / Mä puhun suomea`},{q:`Как спросить «Ты говоришь по-русски?» (вопрос)`,a:`Puhutko venäjää / Puhutko sä venäjää`},{q:`Как сказать «Он говорит по-английски»`,a:`Hän puhuu englantia / Se puhuu englantia`},{q:`Как сказать «Мы говорим по-фински»`,a:`Me puhumme suomea / Me puhutaan suomea`}],"verbi olla":[{q:`Скажи «Я не студентка»`,a:`Minä en ole opiskelija / Mä en oo opiskelija`},{q:`Скажи «Она не дома»`,a:`Hän ei ole kotona / Se ei oo kotona`},{q:`Скажи «Мы не готовы»`,a:`Me emme ole valmiita / Me ei olla valmiita`},{q:`Скажи «Они финны»`,a:`He ovat suomalaisia / Ne on suomalaisia`},{q:`Как спросить «Ты финн?» (вопрос)`,a:`Oletko sinä suomalainen / Ootko sä suomalainen`},{q:`Как спросить «Она дома?» (вопрос)`,a:`Onko hän kotona / Onko se kotona`},{q:`Как сказать «Я в кафе»`,a:`Minä olen kahvilassa / Mä oon kahvilassa`}],vokaaliharmonia:[{q:`В школе (koulu)?`,a:`koulussa`},{q:`На столе (pöytä)?`,a:`pöydällä`},{q:`В городе (kaupunki)?`,a:`kaupungissa`},{q:`На работе (työ)?`,a:`työssä`},{q:`В Турку (Turku)?`,a:`Turussa`},{q:`В лесу (metsä)?`,a:`metsässä`},{q:`В машине (auto)?`,a:`autossa`},{q:`На улице (katu)?`,a:`kadulla`}],numerot:[{q:`Как сказать «13»?`,a:`kolmetoista`},{q:`Как сказать «17»?`,a:`seitsemäntoista`},{q:`Как сказать «30»?`,a:`kolmekymmentä`},{q:`Как сказать «Мне 28 лет»?`,a:`Olen 28-vuotias / Olen kaksikymmentäkahdeksan`},{q:`Как сказать «Кофе стоит 4 евро»?`,a:`Kahvi maksaa neljä euroa`},{q:`Как спросить «Сколько стоит»?`,a:`Paljonko maksaa`},{q:`Как сказать «Сейчас 3 часа»?`,a:`Kello on kolme`}],viikonpäivät:[{q:`Как сказать «В четверг»?`,a:`torstaina`},{q:`Как сказать «В воскресенье»?`,a:`sunnuntaina`},{q:`Как сказать «Сегодня среда»?`,a:`Tänään on keskiviikko`},{q:`Как сказать «Вчера была пятница»?`,a:`Eilen oli perjantai`},{q:`Как сказать «Увидимся в понедельник»?`,a:`Nähdään maanantaina`},{q:`Как спросить «Какой сегодня день»?`,a:`Mikä päivä tänään on`},{q:`Как сказать «Завтра суббота»?`,a:`Huomenna on lauantai`}]};function Ne(e){let t=Object.keys(Me).find(t=>e.toLowerCase().includes(t));return t?[...Me[t]].sort(()=>Math.random()-.5):[]}var Pe=0;function Fe(e){return e.replace(/<[^>]+>/g,``).trim().toLowerCase().replace(/[.,!?;:«»""''()\-]/g,``).replace(/\s+/g,` `).trim()}function Ie(e,t){for(let n=0;n<t.length;n++){if(!e[n])return`пропущено слово «${t[n]}»`;if(e[n]!==t[n])return`«${e[n]}» → должно быть «${t[n]}»`}return e.length>t.length?`лишнее слово «${e[t.length]}»`:null}function Le(e,t){return e.replace(/<\/details>/g,`</details><br>`).replace(/<br>\s*([^<\n]{4,}?)\s*<details><summary>[^<]*<\/summary>([\s\S]*?)<\/details>/g,(e,n,r)=>{let i=`gi-${t}-${Pe++}`,a=r.replace(/<[^>]+>/g,``).replace(/"/g,`&quot;`).trim();return`
        ...
        </div>`})}var Re={ch1:{color:`#7C3AED`,bg:`#EDE7FB`},ch2:{color:`#EC4899`,bg:`#FAE9F2`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`},ch4:{color:`#10B981`,bg:`#E8F7EE`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`}},ze=null,Z=[];function Be(e,t){if(ze=Re[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},Z=t.filter(t=>t.Chapter===e.id).sort((e,t)=>(parseInt(e.Block)||0)-(parseInt(t.Block)||0)),!Z.length)return`
    ...
    <div class="grammar-page">
      ...
      <div class="grammar-header">
        ...
        <div class="progress-bar" style="height: 8px; margin-bottom: 24px">
          <div class="progress-fill" style="width: ${Math.round(a/Z.length*100)}%; background: ${ze.color}; height: 100%"></div>
        </div>
      </div>
  ...
  `}function Ke(e){let t=[],n=new Date;for(let r=7;r>=0;r--){let i=0,a=``;for(let t=0;t<7;t++){let o=new Date(n);o.setDate(n.getDate()-r*7-t),e[o.toISOString().slice(0,10)]&&i++,t===0&&r%2==0&&(a=`${o.getDate()}.${String(o.getMonth()+1).padStart(2,`0`)}`)}t.push({count:i,label:a})}let r=Math.max(...t.map(e=>e.count),1);Math.round(3/r*80);let i=t.map((e,n)=>{let i=e.count>0?Math.max(Math.round(e.count/r*80),8):4,a=n===t.length-1,o=e.count===0;return`
  ...
  `}function qe(){document.getElementById(`btn-back-profile`)?.addEventListener(`click`,()=>A(`/`));let e=document.getElementById(`level-bar-fill`),t=document.getElementById(`level-bar-arrow`),n=parseInt(e?.dataset.pct||`0`);setTimeout(()=>{e&&(e.style.width=`${n}%`),t&&(t.style.left=`${Math.min(n,95)}%`)},150)}var Je={ch1:{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},ch2:{color:`#EC4899`,bg:`#FAE9F2`,img:`ch2.png`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`,img:`ch3.png`},ch4:{color:`#10B981`,bg:`#E8F7EE`,img:`ch4.png`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`,img:`ch5.png`}},Ye=[{id:`ch1`,title_fi:`Hei ja tervetuloa`,title_ru:`Привет и добро пожаловать`,level:`A0–A1`},{id:`ch2`,title_fi:`Minkämaalainen sinä olet?`,title_ru:`Ты откуда?`,level:`A0–A1`},{id:`ch3`,title_fi:`Pedro soittaa Mikkolle`,title_ru:`Педро звонит Микко`,level:`A0–A1`},{id:`ch4`,title_fi:`Minä`,title_ru:`Я`,level:`A0–A1`},{id:`ch5`,title_fi:`Meidän tavallinen päivä`,title_ru:`Наш обычный день`,level:`A0–A1`}],Xe=[`A0–A1`,`A1–A2`,`A2–B1`,`B1–B2`],Ze={"A0–A1":{color:`#7C3AED`,bg:`#EDE7FB`},"A1–A2":{color:`#EC4899`,bg:`#FAE9F2`},"A2–B1":{color:`#F59E0B`,bg:`#FEEEDB`},"B1–B2":{color:`#10B981`,bg:`#E8F7EE`}};function Qe(e){let t=new Date().getHours();return t>=6&&t<12?`Hyvää huomenta, ${e}! ☀️ Готова к финскому?`:t>=12&&t<18?`Hei hei, ${e}! Продолжим?`:`Hyvää iltaa, ${e}! Один урок перед сном?`}function $e(e,t,n=20){let r=e.exercises[t]||{},i=e.vocabulary[t]||{},a=Object.values(r).filter(e=>e.completed).length+Object.values(i).filter(e=>e.seen).length;return Math.min(100,Math.round(a/n*100))}function et(e){let t=e.profiles;return`
    <header class="header">
      <div class="logo">
  ...
  `}function tt(e,t){let n=g();return`
    ${et(e)}
    <div class="hero">
      <div class="hero-text">
    ...
    ${nt(t,n)}
  `}function nt(e,t){let n={};return e.forEach((e,t)=>{let r=e.level||`A0–A1`;n[r]||(n[r]=[]),n[r].push({...e,globalIndex:t})}),Xe.map(e=>{let r=Ze[e]||{color:`#7C3AED`,bg:`#EDE7FB`},i=n[e]||[],a=i.length>0,o=a?i.reduce((e,n)=>e+$e(t,n.id),0)/i.length:0;return`
        <div class="level-section ${a?``:`level-section-soon`}">
          ...
          <div class="chapters-grid">
            ${a?i.map(e=>rt(e,e.globalIndex+1,t)).join(``):[1,2,3].map(e=>`
      ...
      `}).join(``)}function rt(e,t,n){let r=$e(n,e.id),i=r===100,a=r===0?`Начать`:i?`Повторить`:`Продолжить →`;return`
  ...
  `}function Q(e){document.querySelector(`#app`).innerHTML=e}function it(){document.querySelectorAll(`.profile-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profile;p().activeProfile===t?A(`/profile/${t}`):(_(t),ot())})}),document.querySelectorAll(`.chapter-card`).forEach(e=>{e.addEventListener(`click`,()=>{A(`/chapter/${e.dataset.chapter}`)})})}var at=Ye.map(e=>({...e,...Je[e.id]}));function ot(){Q(tt(p(),at)),it()}var $={chapters:[],vocabulary:[],exercises:[]};async function st(){document.querySelector(`#app`).innerHTML=`<div class="loading">Загружаем финский... 🇫🇮</div>`;try{$=await ne(),$.chapters?.length>0&&(at=$.chapters.map(e=>({...e,...Je[e.id]})))}catch{console.log(`Sheets недоступен, используем demo данные`)}ct(),j(ct)}function ct(){let e=k(),t=p();if(e.page===`dashboard`||!e.page){ot();return}if(e.page===`profile`){Q(We(e.profileId)),qe();return}let n=at.find(t=>t.id===e.chapterId);if(!n){ot();return}let r=$.vocabulary.filter(t=>t.chapter_id===e.chapterId),i=$.exercises.filter(t=>t.chapter_id===e.chapterId),a=$.grammar||[];if(e.section===`vocabulary`){Q(ue(n,r)),W(n);return}if(e.section===`exercises`){Q(we(n,i)),Oe(n);return}if(e.section===`grammar`){Q(Be(n,a)),Ve(n);return}Q(N(n,r,i,t,a.filter(t=>t.Chapter===e.chapterId))),P(e.chapterId,r,t.activeProfile)}st();
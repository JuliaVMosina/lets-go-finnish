const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DuqHUYDg.js","assets/index-CdQz-gzi.css"])))=>i.map(i=>d[i]);
import{c as e,d as t,l as n,r,s as i,u as a}from"./index-DuqHUYDg.js";var o=null,s=null,c=[];function l(){return document.querySelector(`#app`)}function u(e){return o=e,s=i[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=r(e.id),f()}function d(){p()}function f(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function p(){document.getElementById(`wr-back-hub`)?.addEventListener(`click`,()=>{n(()=>import(`./index-DuqHUYDg.js`).then(e=>e.t).then(e=>{l().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.wr-task-card`).forEach(t=>{t.addEventListener(`click`,()=>{let n=c[+t.dataset.i];e.writingStart(o.id,n.id),n.type===`form`?m(n):g(n)})})}function m(e){l().innerHTML=`
    <div class="ex-page">
      <header class="header">
    ...
    <div class="ex-page">
      ...
      <div class="ex-container" style="max-width:480px;margin-inline:auto">
        <div class="ex-card">
          <div class="ex-type-badge" style="background:#dcfce7;color:#16a34a">✓ ${n.title}</div>
          <p style="color:#16a34a;font-weight:600;font-size:16px;margin:8px 0 16px">${n.successMsg_ru}</p>
    ...
    </div>`,document.getElementById(`wr-result-back`)?.addEventListener(`click`,()=>{l().innerHTML=f(),p()}),document.getElementById(`wr-hub2`)?.addEventListener(`click`,()=>{l().innerHTML=f(),p()}),document.getElementById(`wr-redo`)?.addEventListener(`click`,()=>m(n))}function g(e){let t=e.template.filter(e=>e.fieldId).map(t=>`
      <div class="wr-field">
    ...
    <div class="ex-page">
      ...
      <div class="ex-container" style="max-width:480px;margin-inline:auto">
        <div class="ex-card">
          <div class="ex-type-badge" style="background:#dcfce7;color:#16a34a">✓ ${n.title}</div>
          <p style="color:#16a34a;font-weight:600;font-size:15px;margin:8px 0 16px">${n.successMsg_ru}</p>
          <div class="wr-message-preview">${i}</div>
          <div style="margin-top:20px;display:flex;flex-direction:column;gap:10px">
    ...
    </div>`,document.getElementById(`wr-msg-result-back`)?.addEventListener(`click`,()=>{l().innerHTML=f(),p()}),document.getElementById(`wr-msg-hub`)?.addEventListener(`click`,()=>{l().innerHTML=f(),p()}),document.getElementById(`wr-msg-redo`)?.addEventListener(`click`,()=>g(n))}export{d as bindWritingPage,u as renderWritingPage};
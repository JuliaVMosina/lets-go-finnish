...
import{c as e,l as t,n,o as r,s as i,u as a}from"./index-CMip-AFb.js";var o=null,s=null,c=[];function l(){return document.querySelector(`#app`)}function u(e){return o=e,s=r[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=n(e.id),f()}function d(){p()}function f(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function p(){document.getElementById(`wr-back-hub`)?.addEventListener(`click`,()=>{e(()=>import(`./index-CMip-AFb.js`).then(e=>e.t).then(e=>{l().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.wr-task-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=c[+e.dataset.i];i.writingStart(o.id,t.id),t.type===`form`?m(t):g(t)})})}function m(e){l().innerHTML=`
    <div class="ex-page">
      <header class="header">
          ...
          <div class="wr-result-card">
            ${e.fields.map(e=>`
              <div class="wr-result-row">
                ...
                <span class="wr-result-value">${n[e.id]}</span>
              </div>`).join(``)}
          </div>
    ...
    <div class="ex-page">
      ...
      <div class="ex-container" style="max-width:480px;margin-inline:auto">
        <div class="ex-card">
          ...
          <div class="wr-message-preview">${r}</div>
          <div style="margin-top:20px;display:flex;flex-direction:column;gap:10px">

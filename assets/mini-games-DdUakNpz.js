...
import{c as e,f as t,l as n,m as r,p as i,u as a}from"./index-3OaFXvpk.js";var o=null,s=null,c=null,l=null,u=[],d=0,f=0;function p(){return document.querySelector(`#app`)}function m(t){return o=t,s=n[t.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=e(t.id),g()}function h(){_()}function g(){if(!c)return`<div class="ex-page"><p style="padding:24px">Мини-игры для этой главы скоро появятся.</p></div>`;let e=s;return`
    <div class="ex-page">
      <header class="header">

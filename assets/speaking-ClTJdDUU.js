...
import{c as e,d as t,i as n,l as r,s as i,u as a}from"./index-BLmbtLfy.js";var o=null,s=null,c=[],l=[],u=0,d=0;function f(){return document.querySelector(`#app`)}function p(e){return o=e,s=i[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=n(e.id),g()}function m(){_()}function h(){let e={};return c.forEach(t=>{e[t.topic]||(e[t.topic]=[]),e[t.topic].push(t)}),e}function g(){let e=h();return`
    <div class="ex-page">
      <header class="header">

...
`,`"`,s.BYTE_ORDER_MARK],s.WORKERS_SUPPORTED=!r&&!!t.Worker,s.NODE_STREAM_INPUT=1,s.LocalChunkSize=10485760,s.RemoteChunkSize=5242880,s.DefaultDelimiter=`,`,s.Parser=h,s.ParserHandle=p,s.NetworkStreamer=l,s.FileStreamer=u,s.StringStreamer=d,s.ReadableStreamStreamer=f,t.jQuery&&((n=t.jQuery).fn.parse=function(e){var r=e.config||{},i=[];return this.each(function(e){if(!(n(this).prop(`tagName`).toUpperCase()===`INPUT`&&n(this).attr(`type`).toLowerCase()===`file`&&t.FileReader)||!this.files||this.files.length===0)return!0;for(var a=0;a<this.files.length;a++)i.push({file:this.files[a],inputElem:this,instanceConfig:n.extend({},r)})}),a(),this;function a(){if(i.length===0)x(e.complete)&&e.complete();else{var t,r,a,c,l=i[0];if(x(e.before)){var u=e.before(l.file,l.inputElem);if(typeof u==`object`){if(u.action===`abort`)return t=`AbortError`,r=l.file,a=l.inputElem,c=u.reason,void(x(e.error)&&e.error({name:t},r,a,c));if(u.action===`skip`)return void o();typeof u.config==`object`&&(l.instanceConfig=n.extend(l.instanceConfig,u.config))}else if(u===`skip`)return void o()}var d=l.instanceConfig.complete;l.instanceConfig.complete=function(e){x(d)&&d(e,l.file,l.inputElem),o()},s.parse(l.file,l.instanceConfig)}}function o(){i.splice(0,1),a()}}),i&&(t.onmessage=function(e){e=e.data,s.WORKER_ID===void 0&&e&&(s.WORKER_ID=e.workerId),typeof e.input==`string`?t.postMessage({workerId:s.WORKER_ID,results:s.parse(e.input,e.config),finished:!0}):(t.File&&e.input instanceof File||e.input instanceof Object)&&(e=s.parse(e.input,e.config))&&t.postMessage({workerId:s.WORKER_ID,results:e,finished:!0})}),(l.prototype=Object.create(c.prototype)).constructor=l,(u.prototype=Object.create(c.prototype)).constructor=u,(d.prototype=Object.create(d.prototype)).constructor=d,(f.prototype=Object.create(c.prototype)).constructor=f,s})}))(),1),T=`2PACX-1vQwqkX44b-HPNysrWI2Qy5AtbUv9DVW8JtDXiFBvoe7lkIbkp-TNP2VjLyli2AUzFFCHZH0HYvcfytH`,E={chapters:`0`,vocabulary:`195278083`,exercises:`1198814770`};function ee(e){return`https://docs.google.com/spreadsheets/d/e/${T}/pub?gid=${e}&single=true&output=csv`}async function D(e){let t=await(await fetch(ee(e))).text();return w.default.parse(t,{header:!0,skipEmptyLines:!0}).data}async function O(){let[e,t,n]=await Promise.all([D(E.chapters),D(E.vocabulary),D(E.exercises)]);return{chapters:e,vocabulary:t,exercises:n}}function k(){let e=(location.hash.replace(`#`,``)||`/`).split(`/`).filter(Boolean);return e.length===0?{page:`dashboard`}:e[0]===`chapter`&&e[1]?{page:e[2]||`chapter`,chapterId:e[1],section:e[2]||null}:e[0]===`profile`&&e[1]?{page:`profile`,profileId:e[1]}:{page:`dashboard`}}function A(e){location.hash=e}function j(e){window.addEventListener(`hashchange`,e)}var M={ch1:{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},ch2:{color:`#EC4899`,bg:`#FAE9F2`,img:`ch2.png`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`,img:`ch3.png`},ch4:{color:`#10B981`,bg:`#E8F7EE`,img:`ch4.png`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`,img:`ch5.png`}};function N(e,t,n,r){let i=e[n]?.[t]||{},a=Object.values(i).filter(e=>e.completed||e.seen).length;return r>0?Math.round(a/r*100):0}function te(e,t,n,r){let i=g(),a=M[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},o=N(i,e.id,`vocabulary`,t.length),s=N(i,e.id,`exercises`,n.length);return`
  ...
  `}function P(e,t,n){document.getElementById(`btn-back`)?.addEventListener(`click`,()=>{A(`/`)});let r=S(n,e,t.length),i=document.getElementById(`vocab-meta`);i&&(i.textContent=`выучено ${r.known} / ${t.length}`),document.querySelectorAll(`.section-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.section;if(n===`grammar`){alert(`Грамматика — скоро!`);return}A(`/chapter/${e}/${n}`)})})}var F={ch1:{color:`#7C3AED`,bg:`#EDE7FB`},ch2:{color:`#EC4899`,bg:`#FAE9F2`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`},ch4:{color:`#10B981`,bg:`#E8F7EE`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`}},I={приветствия:`👋`,числа:`🔢`,"дни недели":`📅`,месяцы:`🗓️`,"времена года":`🍂`,погода:`⛅`,семья:`👨‍👩‍👧‍👦`,одежда:`👕`,цвета:`🎨`,время:`⏰`},L=0,R=[],ne=[],z=null,B=null,V=!1,H=null,U=[];function re(e){let t={};return e.forEach((e,n)=>{let r=e.category||z.id;t[r]||(t[r]=[]),t[r].push({...e,_origIndex:n})}),t}function ie(e,t){z=e,ne=t,B=F[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`};let n=re(t),r=Object.keys(n).sort();return`
    <div class="vocab-page">
      <header class="header">
        <button class="btn-back" id="btn-back-vocab">← ${e.title_fi}</button>
        <span class="vocab-counter">${t.length} слов</span>
      </header>

      <div class="mode-select-screen">
        <h2 class="mode-title">Выбери категорию</h2>

        <div class="category-grid" id="category-grid">
          ${r.map(e=>{let t=n[e],r=I[e]||`📚`,i=e.length>3?e:`Глава ${e.replace(`ch`,``)}`,a=p(),o=a.profiles[a.activeProfile]?.vocabulary[z.id]||{},s=t.filter(e=>o[`w_${e._origIndex}`]?.status===`known`).length,c=t.length>0?Math.round(s/t.length*100):0;return`
              <div class="category-card" data-category="${e}" id="cat-${e}">
                <div class="cat-icon" style="background: ${B.bg}">${r}</div>
                <div class="cat-info">
                  <div class="cat-name">${i}</div>
                  <div class="cat-count">${t.length} слов</div>
                  <div class="progress-bar" style="margin-top: 6px">
                    <div class="progress-fill" style="width: ${c}%; background: ${B.color}"></div>
                  </div>
                  <div class="cat-progress" style="font-size: 11px; color: var(--text-secondary); margin-top: 3px">${s}/${t.length}</div>
                </div>
              </div>
            `}).join(``)}
        </div>
  ...
  `}function ae(e){z=e,B=F[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-vocab`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}`)}),document.querySelectorAll(`.category-card`).forEach(e=>{e.addEventListener(`click`,()=>{H=e.dataset.category,R=re(ne)[H]||[],W()})})}function W(){let e=p(),t=e.profiles[e.activeProfile]?.vocabulary[z.id]||{},n=R.filter(e=>t[`w_${e._origIndex}`]?.status===`known`).length,r=R.filter(e=>t[`w_${e._origIndex}`]?.status===`learning`).length,i=R.filter(e=>t[`w_${e._origIndex}`]?.status===`hard`).length,a=R.length-Object.keys(t).length,o=I[H]||`📚`,s=H.length>3?H:`Глава ${H.replace(`ch`,``)}`;x(e.activeProfile,z.id),`${z.id}${H}`,document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
      <button class="btn-back" id="btn-back-cat">← Категории</button>
      <span class="vocab-counter">${R.length} слов</span>
    </header>

    <div class="mode-select-screen">
      <h2 class="mode-title">${o} ${s}</h2>

      <div class="vocab-stats-row">
        <div class="vocab-stat known"><span class="vs-num">${n}</span><span class="vs-label">знаю ✓</span></div>
        <div class="vocab-stat learning"><span class="vs-num">${r}</span><span class="vs-label">учу</span></div>
        <div class="vocab-stat hard"><span class="vs-num">${i}</span><span class="vs-label">сложно</span></div>
      ...
      <div class="mode-cards">
        ...
        <div class="mode-card" id="mode-test">
          ...
          <div class="mode-info">
            ...
            <div class="mode-desc">Все слова категории · случайный порядок</div>
          </div>
          <button class="mode-btn" style="background: ${B.color}">Начать →</button>
        </div>
        ...
        <div class="mode-card" id="mode-hard">
          ...
          <div class="mode-info">
            ...
            <div class="mode-desc">${i} слов которые вызвали затруднение</div>
          </div>
          <button class="mode-btn" style="background: #EF4444">Повторить →</button>
        </div>`:``}
      </div>
    </div>
  `,oe()}function oe(){document.getElementById(`btn-back-cat`)?.addEventListener(`click`,()=>{document.querySelector(`.vocab-page`).innerHTML=ie(z,ne),ae(z)}),document.getElementById(`mode-flashcard`)?.addEventListener(`click`,()=>se(!1)),document.getElementById(`mode-test`)?.addEventListener(`click`,fe),document.getElementById(`mode-hard`)?.addEventListener(`click`,()=>se(!0))}function se(e=!1){let t=p(),n=t.activeProfile;if(e){let e=t.profiles[n]?.vocabulary[z.id]||{};R=R.filter(t=>e[`w_${t._origIndex}`]?.status===`hard`)}L=0,V=!1,ce()}function ce(){let e=R[L];if(!e){de();return}let t=p(),n=t.profiles[t.activeProfile]?.vocabulary[z.id]||{};n[`w_${e._origIndex}`]?.status,document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
      <button class="btn-back" id="btn-back-fc">← Режимы</button>
      <span class="vocab-counter" id="vocab-counter">${L+1} / ${R.length}</span>
    </header>

    <div class="vocab-container">
      <div class="flashcard" id="flashcard" style="--card-color: ${B.color}; --card-bg: ${B.bg}">
      ...
      <div class="vocab-progress-dots">
        ${R.map((e,t)=>{let r=n[`w_${e._origIndex}`]?.status;return`<span class="vocab-dot ${r===`known`?`dot-known`:r===`hard`?`dot-hard`:r===`learning`?`dot-learning`:``} ${t===L?`active`:``}"></span>`}).join(``)}
      </div>
    </div>
  `,le()}function le(){let e=p(),t=e.profiles[e.activeProfile]?.vocabulary[z.id]||{};document.getElementById(`btn-back-fc`)?.addEventListener(`click`,()=>{let n=R[L];n&&(t[`w_${n._origIndex}`]?.seen||y(e.activeProfile,z.id,n._origIndex,`learning`)),W()});let n=document.getElementById(`flashcard`),r=document.getElementById(`flashcard-inner`);n?.addEventListener(`click`,()=>{V||(V=!0,r.classList.add(`flipped`),document.getElementById(`vocab-actions`).style.display=`flex`)}),document.getElementById(`btn-hard`)?.addEventListener(`click`,()=>ue(`hard`)),document.getElementById(`btn-ok`)?.addEventListener(`click`,()=>ue(`learning`)),document.getElementById(`btn-know`)?.addEventListener(`click`,()=>ue(`known`))}function ue(e){let t=p(),n=R[L];if(y(t.activeProfile,z.id,n._origIndex,e),L++,L>=R.length){de();return}V=!1,ce()}function de(){let e=p(),t=e.profiles[e.activeProfile]?.vocabulary[z.id]||{},n=R.filter(e=>t[`w_${e._origIndex}`]?.status===`known`).length;document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
    ...
    <div class="complete-screen">
      ...
      <p style="color: #6B7280; margin-top: 8px">Знаю: <strong style="color: var(--success)">${n}</strong> из ${R.length} слов</p>
      <div style="display:flex; gap:12px; margin-top:24px; justify-content:center">
        <button class="btn-complete" style="background: ${B.color}" id="btn-repeat">Ещё раз</button>
        <button class="btn-complete" style="background: white; color: ${B.color}; border: 2px solid ${B.color}" id="btn-to-chapter-v">К главе</button>
      </div>
    </div>
  `,document.getElementById(`btn-complete-back`)?.addEventListener(`click`,W),document.getElementById(`btn-repeat`)?.addEventListener(`click`,()=>se(!1)),document.getElementById(`btn-to-chapter-v`)?.addEventListener(`click`,()=>A(`/chapter/${z.id}`))}var G=0,K=0;function fe(){G=0,K=0,U=[...R].sort(()=>Math.random()-.5),pe()}function pe(){if(G>=U.length){he();return}let e=U[G],t=[e,...R.filter(t=>t.finnish!==e.finnish).sort(()=>Math.random()-.5).slice(0,3)].sort(()=>Math.random()-.5);document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
      <button class="btn-back" id="btn-back-test">← Режимы</button>
      <span class="vocab-counter">${G+1} / ${U.length} · ✓ ${K}</span>
    </header>
    <div class="ex-progress-bar">
      <div class="ex-progress-fill" style="width: ${G/U.length*100}%; background: ${B.color}"></div>
    </div>
  ...
  `,document.getElementById(`btn-back-test`)?.addEventListener(`click`,W),me(e)}function me(e){let t=!1;document.querySelectorAll(`.test-option`).forEach(n=>{n.addEventListener(`click`,()=>{if(t)return;t=!0;let r=n.dataset.correct===`true`;r&&K++,document.querySelectorAll(`.test-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===n&&!r&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`test-feedback`);i.style.display=`flex`,i.innerHTML=r?`<div class="feedback-correct" style="border-color: ${B.color}">✓ Правильно!</div>
           <button class="ex-next-btn" id="btn-next-test" style="background: ${B.color}">Дальше →</button>`:`<div class="feedback-wrong">✗ Правильно: <strong>${e.russian}</strong></div>
           <button class="ex-next-btn" id="btn-next-test" style="background: ${B.color}">Дальше →</button>`,i.style.flexDirection=`column`,i.style.gap=`10px`,document.getElementById(`btn-next-test`)?.addEventListener(`click`,()=>{G++,pe()})})})}function he(){let e=p(),t=Math.round(K/U.length*100),n=t>=80?`🏆`:t>=60?`👍`:`💪`;b(e.activeProfile,z.id,K,U.length),document.querySelector(`.vocab-page`).innerHTML=`
    <header class="header">
      <button class="btn-back" id="btn-test-done">← Режимы</button>
    </header>
    <div class="complete-screen">
      <div class="complete-emoji">${n}</div>
      <h2>Тест завершён!</h2>
      <p style="color: #6B7280; margin-top: 8px">Результат: <strong style="color: ${B.color}">${K} / ${U.length}</strong> (${t}%)</p>
      <div style="display:flex; gap:12px; margin-top:24px; justify-content:center">
        <button class="btn-complete" style="background: ${B.color}" id="btn-retest">Ещё раз</button>
        <button class="btn-complete" style="background: white; color: ${B.color}; border: 2px solid ${B.color}" id="btn-to-chapter-t">К главе</button>
      </div>
    </div>
  `,document.getElementById(`btn-test-done`)?.addEventListener(`click`,W),document.getElementById(`btn-retest`)?.addEventListener(`click`,fe),document.getElementById(`btn-to-chapter-t`)?.addEventListener(`click`,()=>A(`/chapter/${z.id}`))}var ge={ch1:{color:`#7C3AED`,bg:`#EDE7FB`},ch2:{color:`#EC4899`,bg:`#FAE9F2`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`},ch4:{color:`#10B981`,bg:`#E8F7EE`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`}},_e={multiple_choice:`☑️ Выбери правильный`,fill_blank:`✏️ Заполни пропуск`,self_check:`👁️ Самопроверка`,matching:`🔗 Соедини пары`,vowel_harmony:`🔤 Гармония гласных`},q=[],J=0,Y=null,X=null,ve=!1;function ye(e,t){return Y=e,q=t,J=0,ve=!1,X=ge[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},q.length?`
    <div class="ex-page">
      <header class="header">
      ...
      <div class="ex-progress-bar">
        <div class="ex-progress-fill" id="ex-progress-fill"
             style="width: ${be(0)}%; background: ${X.color}"></div>
      </div>
  ...
  `:`
      ...
      </div>`}function be(e){return Math.round(e/q.length*100)}function xe(e){return e.map(e=>({v:e,sort:Math.random()})).sort((e,t)=>e.sort-t.sort).map(({v:e})=>e)}function Se(e,t){let n=e.type||`multiple_choice`,r=_e[n]||n,i=[e.option_a,e.option_b,e.option_c,e.option_d].filter(Boolean),a=`abcd`.indexOf((e.correct||`a`).toLowerCase()),o=i[a]||i[0],s=n===`self_check`?i:xe(i.map((e,t)=>({text:e,isCorrect:t===a})));return n===`self_check`?`
  ...
  `}function Ce(e){Y=e,X=ge[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}`)}),we()}function we(){let e=q[J];e&&(ve=!1,document.getElementById(`btn-show-answer`)?.addEventListener(`click`,()=>{document.getElementById(`answer-reveal`).style.display=`block`,document.getElementById(`btn-show-answer`).style.display=`none`}),document.querySelectorAll(`.self-btn`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.result,v(p().activeProfile,Y.id,J,e.dataset.result),Te()})}),document.querySelectorAll(`.ex-option`).forEach(t=>{t.addEventListener(`click`,()=>{if(ve)return;ve=!0;let n=t.dataset.correct===`true`,r=document.querySelector(`.ex-card`).dataset.correct;document.querySelectorAll(`.ex-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===t&&!n&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`ex-feedback`);i.style.display=`block`,i.innerHTML=n?`<div class="feedback-correct" style="border-color: ${X.color}">
           ...
           <button class="ex-next-btn" id="btn-next" style="background: ${X.color}">
             ${J+1<q.length?`Следующее →`:`Завершить 🎉`}
           </button>`,v(p().activeProfile,Y.id,J,n?`right`:`wrong`),document.getElementById(`btn-next`)?.addEventListener(`click`,Te)})}))}function Te(){if(J++,J>=q.length){Ee();return}let e=document.getElementById(`ex-container`);e.innerHTML=Se(q[J],J),document.getElementById(`ex-counter`).textContent=`${J+1} / ${q.length}`,document.getElementById(`ex-progress-fill`).style.width=`${be(J)}%`,we()}function Ee(){let e=document.getElementById(`ex-container`);e.innerHTML=`
    <div class="complete-screen">
      <div class="complete-emoji">🏆</div>
  ...
  `,document.getElementById(`btn-to-chapter-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${Y.id}`)})}var Z=[{id:`A0–A1`,label:`A0–A1`,color:`#7C3AED`,bg:`#EDE7FB`,chapters:[`ch1`,`ch2`,`ch3`,`ch4`,`ch5`]},{id:`A1–A2`,label:`A1–A2`,color:`#EC4899`,bg:`#FAE9F2`,chapters:[`ch6`,`ch7`,`ch8`,`ch9`,`ch10`]},{id:`A2–B1`,label:`A2–B1`,color:`#F59E0B`,bg:`#FEEEDB`,chapters:[`ch11`,`ch12`,`ch13`,`ch14`,`ch15`]},{id:`B1–B2`,label:`B1–B2`,color:`#10B981`,bg:`#E8F7EE`,chapters:[`ch16`,`ch17`,`ch18`,`ch19`,`ch20`]}];function De(e){let t=p().profiles[e];for(let e=0;e<Z.length;e++){let n=Z[e],r=Z[e+1],i=n.chapters.filter(e=>{let n=t.vocabulary[e]||{},r=t.exercises[e]||{};return Object.values(n).filter(e=>e.seen).length>0||Object.values(r).filter(e=>e.completed).length>0}).length,a=n.chapters.length,o=Math.round(i/a*100);if(o<100)return{current:n,next:r,completed:i,total:a,pct:o}}let n=Z[Z.length-1];return{current:n,next:null,completed:n.chapters.length,total:n.chapters.length,pct:100}}function Oe(e){let t=p().profiles[e],{totalWords:n,totalExercises:r,totalChapters:i,streak:a,activity:o}=C(e),{current:s,next:c,completed:l,total:u,pct:d}=De(e);return`
  ...
  `}function Ae(e){let t=[],n=new Date;for(let r=7;r>=0;r--){let i=0,a=``;for(let t=0;t<7;t++){let o=new Date(n);o.setDate(n.getDate()-r*7-t),e[o.toISOString().slice(0,10)]&&i++,t===0&&r%2==0&&(a=`${o.getDate()}.${String(o.getMonth()+1).padStart(2,`0`)}`)}t.push({count:i,label:a})}let r=Math.max(...t.map(e=>e.count),1);Math.round(3/r*80);let i=t.map((e,n)=>{let i=e.count>0?Math.max(Math.round(e.count/r*80),8):4,a=n===t.length-1,o=e.count===0;return`
  ...
  `}function je(){document.getElementById(`btn-back-profile`)?.addEventListener(`click`,()=>A(`/`));let e=document.getElementById(`level-bar-fill`),t=document.getElementById(`level-bar-arrow`),n=parseInt(e?.dataset.pct||`0`);setTimeout(()=>{e&&(e.style.width=`${n}%`),t&&(t.style.left=`${Math.min(n,95)}%`)},150)}var Me={ch1:{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},ch2:{color:`#EC4899`,bg:`#FAE9F2`,img:`ch2.png`},ch3:{color:`#F59E0B`,bg:`#FEEEDB`,img:`ch3.png`},ch4:{color:`#10B981`,bg:`#E8F7EE`,img:`ch4.png`},ch5:{color:`#3B82F6`,bg:`#E9EEFB`,img:`ch5.png`}},Ne=[{id:`ch1`,title_fi:`Hei ja tervetuloa`,title_ru:`Привет и добро пожаловать`,level:`A0–A1`},{id:`ch2`,title_fi:`Minkämaalainen sinä olet?`,title_ru:`Ты откуда?`,level:`A0–A1`},{id:`ch3`,title_fi:`Pedro soittaa Mikkolle`,title_ru:`Педро звонит Микко`,level:`A0–A1`},{id:`ch4`,title_fi:`Minä`,title_ru:`Я`,level:`A0–A1`},{id:`ch5`,title_fi:`Meidän tavallinen päivä`,title_ru:`Наш обычный день`,level:`A0–A1`}],Pe=[`A0–A1`,`A1–A2`,`A2–B1`,`B1–B2`],Fe={"A0–A1":{color:`#7C3AED`,bg:`#EDE7FB`},"A1–A2":{color:`#EC4899`,bg:`#FAE9F2`},"A2–B1":{color:`#F59E0B`,bg:`#FEEEDB`},"B1–B2":{color:`#10B981`,bg:`#E8F7EE`}};function Ie(e){let t=new Date().getHours();return t>=6&&t<12?`Hyvää huomenta, ${e}! ☀️ Готова к финскому?`:t>=12&&t<18?`Hei hei, ${e}! Продолжим?`:`Hyvää iltaa, ${e}! Один урок перед сном?`}function Le(e,t,n=20){let r=e.exercises[t]||{},i=e.vocabulary[t]||{},a=Object.values(r).filter(e=>e.completed).length+Object.values(i).filter(e=>e.seen).length;return Math.min(100,Math.round(a/n*100))}function Re(e){let t=e.profiles;return`
    <header class="header">
      <div class="logo">
  ...
  `}function ze(e,t){let n=g();return`
    ...
    ${Be(t,n)}
  `}function Be(e,t){let n={};return e.forEach((e,t)=>{let r=e.level||`A0–A1`;n[r]||(n[r]=[]),n[r].push({...e,globalIndex:t})}),Pe.map(e=>{let r=Fe[e]||{color:`#7C3AED`,bg:`#EDE7FB`},i=n[e]||[],a=i.length>0,o=a?i.reduce((e,n)=>e+Le(t,n.id),0)/i.length:0;return`
        <div class="level-section ${a?``:`level-section-soon`}">
          ...
          <div class="chapters-grid">
            ${a?i.map(e=>Ve(e,e.globalIndex+1,t)).join(``):[1,2,3].map(e=>`
      ...
      `}).join(``)}function Ve(e,t,n){let r=Le(n,e.id),i=r===100,a=r===0?`Начать`:i?`Повторить`:`Продолжить →`;return`
  ...
  `}function Q(e){document.querySelector(`#app`).innerHTML=e}function He(){document.querySelectorAll(`.profile-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.profile;p().activeProfile===t?A(`/profile/${t}`):(_(t),We())})}),document.querySelectorAll(`.chapter-card`).forEach(e=>{e.addEventListener(`click`,()=>{A(`/chapter/${e.dataset.chapter}`)})})}var Ue=Ne.map(e=>({...e,...Me[e.id]}));function We(){Q(ze(p(),Ue)),He()}var $={chapters:[],vocabulary:[],exercises:[]};async function Ge(){document.querySelector(`#app`).innerHTML=`<div class="loading">Загружаем финский... 🇫🇮</div>`;try{$=await O(),$.chapters?.length>0&&(Ue=$.chapters.map(e=>({...e,...Me[e.id]})))}catch{console.log(`Sheets недоступен, используем demo данные`)}Ke(),j(Ke)}function Ke(){let e=k(),t=p();if(e.page===`dashboard`||!e.page){We();return}if(e.page===`profile`){Q(Oe(e.profileId)),je();return}let n=Ue.find(t=>t.id===e.chapterId);if(!n){We();return}let r=$.vocabulary.filter(t=>t.chapter_id===e.chapterId),i=$.exercises.filter(t=>t.chapter_id===e.chapterId);if(e.section===`vocabulary`){Q(ie(n,r)),ae(n);return}if(e.section===`exercises`){Q(ye(n,i)),Ce(n);return}Q(te(n,r,i,t)),P(e.chapterId,r,t.activeProfile)}Ge();
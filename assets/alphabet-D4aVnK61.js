...
import{c as e,d as t,f as n,l as r,r as i,u as a}from"./index-BUfmuiSz.js";var o=null,s=null,c=null,l=0,u=0;function d(){return document.querySelector(`#app`)}function f(t){return o=t,s=e[t.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=i(),r.exerciseStart?.(t.id,`alphabet`),m()}function p(){h()}function m(){let{color:e,bg:t}=s,n=new Set(c.special),r=c.letters.map(e=>`
    ...
    </div>`,document.getElementById(`ab-done-back`)?.addEventListener(`click`,()=>{d().innerHTML=m(),h()}),document.getElementById(`ab-retry`)?.addEventListener(`click`,()=>{l=0,u=0,g()}),document.getElementById(`ab-to-hub`)?.addEventListener(`click`,()=>{a(()=>import(`./index-BUfmuiSz.js`).then(e=>e.t).then(e=>{d().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))})}export{p as bindAlphabetPage,f as renderAlphabetPage};
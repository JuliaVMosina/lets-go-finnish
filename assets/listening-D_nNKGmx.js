const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-zkehfUsJ.js","assets/index-CdQz-gzi.css"])))=>i.map(i=>d[i]);
import{c as e,d as t,f as n,l as r,o as i,u as a}from"./index-zkehfUsJ.js";function o(e){return e===`puhekieli`?`<span class="reg-badge reg-puhe">💬 puhekieli</span>`:e===`kirjakieli`?`<span class="reg-badge reg-kirja">📖 kirjakieli</span>`:``}var s=null,c=null,l=[],u=0,d=0,f=!1;function p(){return document.querySelector(`#app`)}function m(t){return s=t,c=e[t.id]||{color:`#7C3AED`,bg:`#EDE7FB`},l=i(t.id),u=0,d=0,g()}function h(){_()}function g(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function _(){document.getElementById(`ls-back-list`)?.addEventListener(`click`,()=>{a(()=>import(`./index-zkehfUsJ.js`).then(e=>e.t).then(e=>{p().innerHTML=e.renderExercisesPage(s,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.ls-track-card`).forEach(e=>{e.addEventListener(`click`,()=>{u=+e.dataset.i,d=0,f=!1,r.listeningStart(s.id,l[u].id),v()})})}function v(){let e=l[u];y(e,0)}function y(e,t){let n=e.questions[t],r=t===e.questions.length-1,i=Math.round(t/e.questions.length*100);p().innerHTML=`
    <div class="ex-page">
      <header class="header">
    ...
    <div class="ex-page">
      ...
      <div class="ex-container" style="text-align:center;padding-top:40px">
        ...
        <p style="color:#6B7280">Результат: <strong style="color:${c.color}">${d} / ${i}</strong> (${a}%)</p>
    ...
    </div>`,document.getElementById(`ls-back-done`)?.addEventListener(`click`,()=>{p().innerHTML=g(),_()}),document.getElementById(`ls-all`)?.addEventListener(`click`,()=>{p().innerHTML=g(),_()}),document.getElementById(`ls-retry`)?.addEventListener(`click`,()=>{d=0,f=!1,y(r,0)})}export{h as bindListeningPage,m as renderListeningPage};
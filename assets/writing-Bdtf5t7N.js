const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Cd5jbDNY.js","assets/index-CdQz-gzi.css"])))=>i.map(i=>d[i]);
import{c as e,d as t,l as n,r,s as i,u as a}from"./index-Cd5jbDNY.js";var o=null,s=null,c=[];function l(){return document.querySelector(`#app`)}function u(e){return o=e,s=i[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=r(e.id),f()}function d(){p()}function f(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function p(){document.getElementById(`wr-back-hub`)?.addEventListener(`click`,()=>{n(()=>import(`./index-Cd5jbDNY.js`).then(e=>e.t).then(e=>{l().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.wr-task-card`).forEach(t=>{t.addEventListener(`click`,()=>{let n=c[+t.dataset.i];e.writingStart(o.id,n.id),n.type===`form`?m(n):g(n)})})}function m(e){l().innerHTML=`
    <div class="ex-page">
      <header class="header">

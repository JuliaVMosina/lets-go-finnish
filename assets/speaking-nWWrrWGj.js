...
import{c as e,d as t,i as n,l as r,s as i,u as a}from"./index-Dy-EJuwU.js";var o=null,s=null,c=[],l=[],u=0,d=0;function f(){return document.querySelector(`#app`)}function p(e){return o=e,s=i[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},c=n(e.id),g()}function m(){_()}function h(){let e={};return c.forEach(t=>{e[t.topic]||(e[t.topic]=[]),e[t.topic].push(t)}),e}function g(){let e=h();return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function _(){document.getElementById(`sp-back-hub`)?.addEventListener(`click`,()=>{r(()=>import(`./index-Dy-EJuwU.js`).then(e=>e.t).then(e=>{f().innerHTML=e.renderExercisesPage(o,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.sp-topic-card`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.topic;l=b(n===`all`?[...c]:c.filter(e=>e.topic===n)),u=0,d=0,e.speakingStart(o.id,n),v()})})}function v(){let e=l[u],t=Math.round(u/l.length*100),n=u===l.length-1;f().innerHTML=`
    <div class="ex-page">
      <header class="header">
    ...
    <div class="ex-page">
      ...
      <div class="ex-container" style="text-align:center;padding-top:40px">
        ...
        <p style="color:#6B7280">Распознано верно: <strong style="color:${s.color}">${d} / ${n}</strong> (${r}%)</p>

...
import{c as e,n as t,o as n,s as r}from"./index-DZoUCo_D.js";var i=null,a=null,o=[];function s(){return document.querySelector(`#app`)}function c(e){return i=e,a=n[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},o=t(e.id),u()}function l(){d()}function u(){return`
    <div class="ex-page">
      <header class="header">
    ...
    </div>`}function d(){document.getElementById(`wr-back-hub`)?.addEventListener(`click`,()=>{e(()=>import(`./index-DZoUCo_D.js`).then(e=>e.t).then(e=>{s().innerHTML=e.renderExercisesPage(i,[],[]),e.bindExercisesPage()}),__vite__mapDeps([0,1]))}),document.querySelectorAll(`.wr-task-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=o[+e.dataset.i];r.writingStart(i.id,t.id),t.type===`form`?f(t):m(t)})})}function f(e){s().innerHTML=`
    <div class="ex-page">
      <header class="header">

...
`&&n!==`\r`&&n!==`\r
`&&(n=`
`);var f=0,p=!1;this.parse=function(s,h,g){if(typeof s!=`string`)throw Error(`Input must be a string`);var _=s.length,v=t.length,y=n.length,b=r.length,S=x(i),C=[],w=[],T=[],ee=f=0;if(!s)return M();if(o||!1!==o&&s.indexOf(u)===-1){for(var te=s.split(n),E=0;E<te.length;E++){if(T=te[E],f+=T.length,E!==te.length-1)f+=n.length;else if(g)return M();if(!r||T.substring(0,b)!==r){if(S){if(C=[],re(T.split(t)),oe(),p)return M()}else re(T.split(t));if(a&&a<=E)return C=C.slice(0,a),M(!0)}}return M()}for(var D=s.indexOf(t,f),O=s.indexOf(n,f),ne=new RegExp(m(d)+m(u),`g`),k=s.indexOf(u,f);;)if(s[f]===u)for(k=f,f++;;){if((k=s.indexOf(u,k+1))===-1)return g||w.push({type:`Quotes`,code:`MissingQuotes`,message:`Quoted field unterminated`,row:C.length,index:f}),ie();if(k===_-1)return ie(s.substring(f,k).replace(ne,u));if(u===d&&s[k+1]===d)k++;else if(u===d||k===0||s[k-1]!==d){D!==-1&&D<k+1&&(D=s.indexOf(t,k+1));var A=j((O=O!==-1&&O<k+1?s.indexOf(n,k+1):O)===-1?D:Math.min(D,O));if(s.substr(k+1+A,v)===t){T.push(s.substring(f,k).replace(ne,u)),s[f=k+1+A+v]!==u&&(k=s.indexOf(u,f)),D=s.indexOf(t,f),O=s.indexOf(n,f);break}if(A=j(O),s.substring(k+1+A,k+1+A+y)===n){if(T.push(s.substring(f,k).replace(ne,u)),ae(k+1+A+y),D=s.indexOf(t,f),k=s.indexOf(u,f),S&&(oe(),p))return M();if(a&&C.length>=a)return M(!0);break}w.push({type:`Quotes`,code:`InvalidQuotes`,message:`Trailing quote on quoted field is malformed`,row:C.length,index:f}),k++}}else if(r&&T.length===0&&s.substring(f,f+b)===r){if(O===-1)return M();f=O+y,O=s.indexOf(n,f),D=s.indexOf(t,f)}else if(D!==-1&&(D<O||O===-1))T.push(s.substring(f,D)),f=D+v,D=s.indexOf(t,f);else{if(O===-1)break;if(T.push(s.substring(f,O)),ae(O+y),S&&(oe(),p))return M();if(a&&C.length>=a)return M(!0)}return ie();function re(e){C.push(e),ee=f}function j(e){var t=0;return t=e!==-1&&(e=s.substring(k+1,e))&&e.trim()===``?e.length:t}function ie(e){return g||(e===void 0&&(e=s.substring(f)),T.push(e),f=_,re(T),S&&oe()),M()}function ae(e){f=e,re(T),T=[],O=s.indexOf(n,f)}function M(r){if(e.header&&!h&&C.length&&!l){var i=C[0],a=Object.create(null),o=new Set(i);let t=!1;for(let n=0;n<i.length;n++){let r=i[n];if(a[r=x(e.transformHeader)?e.transformHeader(r,n):r]){let e,s=a[r];for(;e=r+`_`+s,s++,o.has(e););o.add(e),i[n]=e,a[r]++,t=!0,(c=c===null?{}:c)[e]=r}else a[r]=1,i[n]=r;o.add(r)}t&&console.warn(`Duplicate headers found and renamed.`),l=!0}return{data:C,errors:w,meta:{delimiter:t,linebreak:n,aborted:p,truncated:!!r,cursor:ee+(h||0),renamedHeaders:c}}}function oe(){i(M()),C=[],w=[]}},this.abort=function(){p=!0},this.getCharIndex=function(){return f}}function g(e){var t=e.data,n=a[t.workerId],r=!1;if(t.error)n.userError(t.error,t.file);else if(t.results&&t.results.data){var i={abort:function(){r=!0,_(t.workerId,{data:[],errors:[],meta:{aborted:!0}})},pause:v,resume:v};if(x(n.userStep)){for(var o=0;o<t.results.data.length&&(n.userStep({data:t.results.data[o],errors:t.results.errors,meta:t.results.meta},i),!r);o++);delete t.results}else x(n.userChunk)&&(n.userChunk(t.results,i,t.file),delete t.results)}t.finished&&!r&&_(t.workerId,t.results)}function _(e,t){var n=a[e];x(n.userComplete)&&n.userComplete(t),n.terminate(),delete a[e]}function v(){throw Error(`Not implemented.`)}function y(e){if(typeof e!=`object`||!e)return e;var t,n=Array.isArray(e)?[]:{};for(t in e)n[t]=y(e[t]);return n}function b(e,t){return function(){e.apply(t,arguments)}}function x(e){return typeof e==`function`}return s.parse=function(n,r){var i=(r||={}).dynamicTyping||!1;if(x(i)&&(r.dynamicTypingFunction=i,i={}),r.dynamicTyping=i,r.transform=!!x(r.transform)&&r.transform,!r.worker||!s.WORKERS_SUPPORTED)return i=null,s.NODE_STREAM_INPUT,typeof n==`string`?(n=(e=>e.charCodeAt(0)===65279?e.slice(1):e)(n),i=new(r.download?l:d)(r)):!0===n.readable&&x(n.read)&&x(n.on)?i=new f(r):(t.File&&n instanceof File||n instanceof Object)&&(i=new u(r)),i.stream(n);(i=(()=>{var n;return!!s.WORKERS_SUPPORTED&&(n=(()=>{var n=t.URL||t.webkitURL||null,r=e.toString();return s.BLOB_URL||=n.createObjectURL(new Blob([`var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; `,`(`,r,`)();`],{type:`text/javascript`}))})(),(n=new t.Worker(n)).onmessage=g,n.id=o++,a[n.id]=n)})()).userStep=r.step,i.userChunk=r.chunk,i.userComplete=r.complete,i.userError=r.error,r.step=x(r.step),r.chunk=x(r.chunk),r.complete=x(r.complete),r.error=x(r.error),delete r.worker,i.postMessage({input:n,config:r,workerId:i.id})},s.unparse=function(e,t){var n=!1,r=!0,i=`,`,a=`\r
...
`,`"`,s.BYTE_ORDER_MARK],s.WORKERS_SUPPORTED=!r&&!!t.Worker,s.NODE_STREAM_INPUT=1,s.LocalChunkSize=10485760,s.RemoteChunkSize=5242880,s.DefaultDelimiter=`,`,s.Parser=h,s.ParserHandle=p,s.NetworkStreamer=l,s.FileStreamer=u,s.StringStreamer=d,s.ReadableStreamStreamer=f,t.jQuery&&((n=t.jQuery).fn.parse=function(e){var r=e.config||{},i=[];return this.each(function(e){if(!(n(this).prop(`tagName`).toUpperCase()===`INPUT`&&n(this).attr(`type`).toLowerCase()===`file`&&t.FileReader)||!this.files||this.files.length===0)return!0;for(var a=0;a<this.files.length;a++)i.push({file:this.files[a],inputElem:this,instanceConfig:n.extend({},r)})}),a(),this;function a(){if(i.length===0)x(e.complete)&&e.complete();else{var t,r,a,c,l=i[0];if(x(e.before)){var u=e.before(l.file,l.inputElem);if(typeof u==`object`){if(u.action===`abort`)return t=`AbortError`,r=l.file,a=l.inputElem,c=u.reason,void(x(e.error)&&e.error({name:t},r,a,c));if(u.action===`skip`)return void o();typeof u.config==`object`&&(l.instanceConfig=n.extend(l.instanceConfig,u.config))}else if(u===`skip`)return void o()}var d=l.instanceConfig.complete;l.instanceConfig.complete=function(e){x(d)&&d(e,l.file,l.inputElem),o()},s.parse(l.file,l.instanceConfig)}}function o(){i.splice(0,1),a()}}),i&&(t.onmessage=function(e){e=e.data,s.WORKER_ID===void 0&&e&&(s.WORKER_ID=e.workerId),typeof e.input==`string`?t.postMessage({workerId:s.WORKER_ID,results:s.parse(e.input,e.config),finished:!0}):(t.File&&e.input instanceof File||e.input instanceof Object)&&(e=s.parse(e.input,e.config))&&t.postMessage({workerId:s.WORKER_ID,results:e,finished:!0})}),(l.prototype=Object.create(c.prototype)).constructor=l,(u.prototype=Object.create(c.prototype)).constructor=u,(d.prototype=Object.create(d.prototype)).constructor=d,(f.prototype=Object.create(c.prototype)).constructor=f,s})}))(),1),te=`2PACX-1vQwqkX44b-HPNysrWI2Qy5AtbUv9DVW8JtDXiFBvoe7lkIbkp-TNP2VjLyli2AUzFFCHZH0HYvcfytH`,E={chapters:`0`,vocabulary:`195278083`,exercises:`1198814770`,grammar:`877359757`};function D(e){return`https://docs.google.com/spreadsheets/d/e/${te}/pub?gid=${e}&single=true&output=csv`}async function O(e){let t=await(await fetch(D(e))).text();return ee.default.parse(t,{header:!0,skipEmptyLines:!0}).data}async function ne(){let[e,t,n,r]=await Promise.all([O(E.chapters),O(E.vocabulary),O(E.exercises),O(E.grammar)]);return{chapters:e,vocabulary:t,exercises:n,grammar:r}}function k(){let e=(location.hash.replace(`#`,``)||`/`).split(`/`).filter(Boolean);return e.length===0?{page:`dashboard`}:e[0]===`chapter`&&e[1]?{page:e[2]||`chapter`,chapterId:e[1],section:e[2]||null}:e[0]===`profile`&&e[1]?{page:`profile`,profileId:e[1]}:{page:`dashboard`}}function A(e){location.hash=e}function re(e){window.addEventListener(`hashchange`,e)}var j={ch1:{color:`#7C3AED`,bg:`#F1EDFC`,img:`ch1.png`},ch2:{color:`#D6317A`,bg:`#FCECF3`,img:`ch2.png`},ch3:{color:`#D97706`,bg:`#FEF3E6`,img:`ch3.png`},ch4:{color:`#059669`,bg:`#EBF7F0`,img:`ch4.png`},ch5:{color:`#2563EB`,bg:`#E5EDFC`,img:`ch5.png`},ch6:{color:`#7C3AED`,bg:`#F0EDFC`,img:`ch6.png`},ch7:{color:`#E11D48`,bg:`#FDEAF1`,img:`ch7.png`},ch8:{color:`#EA580C`,bg:`#FEF3E6`,img:`ch8.png`},ch9:{color:`#047857`,bg:`#EBF6EE`,img:`ch9.png`}};function ie(e,t,n,r){let i=e[n]?.[t]||{},a=Object.values(i).filter(e=>e.completed||e.seen).length;return r>0?Math.round(a/r*100):0}var ae={ch1:`👋 К концу этой главы ты сможешь поздороваться, представиться и назвать день недели — по-фински. Это твои первые живые слова!`};function M(e,t,n,r,i=[]){let a=g(),o=j[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`,img:`ch1.png`},s=ie(a,e.id,`vocabulary`,t.length),c=ie(a,e.id,`exercises`,n.length),l=i.length,u=a.grammarProgress?.[e.id]||{},d=Object.values(u).filter(e=>e===!0).length,f=l>0?Math.round(d/l*100):0,p=Math.round((s+f+c)/3),m=ae[e.id];return`
      ...
      <div class="sections-grid">
        ...
        <div class="section-card" id="section-exercises">
          ...
          <div class="section-info">
            ...
            <div class="section-meta" id="ex-meta">загрузка...</div>
            <div class="progress-bar" style="margin-top: 8px">
  ...
  `}function oe(e,t,n,r=[]){document.getElementById(`btn-back`)?.addEventListener(`click`,()=>{A(`/`)});let i=C(n,e,t.length),a=document.getElementById(`vocab-meta`);a&&(a.textContent=`выучено ${i.known} / ${t.length}`);let o=document.getElementById(`ex-meta`);if(o)if(r.length>0){let t=p().profiles[n]?.exercises[e]||{};o.textContent=`выполнено ${Object.values(t).filter(e=>e.completed).length} / ${r.length}`}else o.textContent=`задания`;document.querySelectorAll(`.section-card`).forEach(t=>{t.style.cursor=`pointer`,t.addEventListener(`click`,()=>{let n=t.querySelector(`.section-btn`)?.dataset.section;n&&A(`/chapter/${e}/${n}`)})}),document.querySelectorAll(`.section-btn`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation();let r=t.dataset.section;A(`/chapter/${e}/${r}`)})})}var N=0,P=[],se=[],F=null,I=null,L=!1,ce=null,R=[],le=null,ue={приветствия:`👋`,числа:`🔢`,"дни недели":`📅`,месяцы:`🗓️`,"времена года":`🍂`,погода:`⛅`,семья:`👨‍👩‍👧‍👦`,одежда:`👕`,цвета:`🎨`,время:`⏰`};function de(e){let t={};return e.forEach((e,n)=>{let r=e.category||F.id;t[r]||(t[r]=[]),t[r].push({...e,_origIndex:n})}),t}function fe(){let e=p(),t=x(e.activeProfile,F.id),n=S(e.activeProfile,F.id),r=Object.keys(n).length>0,i=t&&!t.category?t:null;if(!i&&!r)return`
    ...
    <div class="mode-card" id="mode-test">
      <div class="mode-icon" style="background: ${i?.pct>=80?`#F0FDF4`:I.bg}">${s}</div>
      <div class="mode-info">
        <div class="mode-name">Тест</div>
        ${a}
        ${o}
    ...
    <div class="mode-select-screen">
      ...
      <div class="learning-path">
        <div class="path-intro">В этой главе <strong>${P.length} слов</strong></div>
        <div class="path-steps">
          ...
          <div class="path-step ${n>=Math.ceil(P.length*.8)?`step-done`:n+i>0?`step-active`:`step-locked`}">
          ...
          <div class="path-arrow">→</div>
          <div class="path-step ${n>=Math.ceil(P.length*.8)?`step-active`:`step-locked`}">
            <div class="path-step-num">✓</div>
            <div class="path-step-text">
              <div class="path-step-title">Глава освоена</div>
              <div class="path-step-sub">${n} / ${P.length} слов</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="mode-info">
            ...
            <div class="learning-progress" style="margin-top: 10px">
              <div style="display: flex; justify-content: space-between; font-size: 12px; margin-bottom: 4px">
                ...
                <span style="color: #999">${P.length} всего</span>
              </div>
              <div class="progress-bar" style="height: 6px">
                <div class="progress-fill" style="width: ${Math.round((n+i)/P.length*100)}%; background: ${I.color}"></div>
              </div>
            </div>
          </div>
          <button class="mode-btn" style="background: ${I.color}">Начать →</button>
      ...
      <div class="mode-cards">
        <div class="mode-card" id="source-all">
          ...
          <div class="mode-info">
            ...
            <div class="mode-desc">${se.length} слов · вся глава</div>
          </div>
          <button class="mode-btn" style="background: ${I.color}">Начать →</button>
        </div>
      </div>
  ...
  `;document.querySelector(`.vocab-page`).innerHTML=r,document.getElementById(`btn-back-source`)?.addEventListener(`click`,()=>{document.querySelector(`.vocab-page`).innerHTML=pe(),he(F)}),document.getElementById(`source-all`)?.addEventListener(`click`,()=>{P=se,le=null,ce===`flashcard`?_e(!1):we()}),document.querySelectorAll(`.category-card`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.category;P=t[n]||[],le=n,ce===`flashcard`?_e(!1):we()})})}function _e(e=!1){let t=p(),n=t.activeProfile;if(e){let e=t.profiles[n]?.vocabulary[F.id]||{},r=Object.entries(e).filter(([,e])=>e.status===`hard`).map(([e])=>parseInt(e.replace(`w_`,``)));N=0,P=r.map(e=>({...P[e],_origIndex:e}))}else P=[...P].map((e,t)=>({...e,_origIndex:t})),N=w(n,F.id,P);L=!1,ve()}function ve(){let e=P[N];if(!e){xe();return}let t=p(),n=t.profiles[t.activeProfile]?.vocabulary[F.id]||{};n[`w_${e._origIndex??N}`]?.status,document.querySelector(`.vocab-page`).innerHTML=`
    ...
    <div class="ex-progress-bar">
      <div class="ex-progress-fill" style="width: ${N/P.length*100}%; background: ${I.color}"></div>
    </div>

    <div class="vocab-container">
      <div class="flashcard" id="flashcard" style="--card-color: ${I.color}; --card-bg: ${I.bg}">
  ...
  `,ye()}function ye(){document.getElementById(`btn-back-fc`)?.addEventListener(`click`,()=>{let e=p(),t=P[N];if(t){let n=t._origIndex??N;e.profiles[e.activeProfile]?.vocabulary[F.id]?.[`w_${n}`]?.seen||y(e.activeProfile,F.id,n,`learning`)}P=F._allWords||P,document.querySelector(`.vocab-page`).innerHTML=pe(),he(F)});let e=document.getElementById(`flashcard`),t=document.getElementById(`flashcard-inner`),n=P[N];e?.addEventListener(`click`,e=>{e.target.closest(`.card-audio-btn`)||e.target.closest(`.card-mic-btn`)||(L=!L,t.classList.toggle(`flipped`,L),document.getElementById(`vocab-actions`).style.display=L?`flex`:`none`)});function r(e){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e);t.lang=`fi-FI`,t.rate=.85,window.speechSynthesis.speak(t)}document.getElementById(`btn-audio-front`)?.addEventListener(`click`,e=>{e.stopPropagation(),r(n.finnish)}),document.getElementById(`btn-audio-back`)?.addEventListener(`click`,e=>{e.stopPropagation(),r(n.finnish)}),document.getElementById(`btn-mic`)?.addEventListener(`click`,e=>{e.stopPropagation();let t=document.getElementById(`btn-mic`),r=document.getElementById(`mic-result`),i=window.SpeechRecognition||window.webkitSpeechRecognition;if(!i){r.style.display=`block`,r.innerHTML=`<span style="color:#F59E0B">⚠️ Ваш браузер не поддерживает распознавание речи</span>`;return}let a=new i;a.lang=`fi-FI`,a.interimResults=!1,a.maxAlternatives=5;function o(){t.textContent=`🎤 Попробуй ещё раз`,t.disabled=!1}t.textContent=`🔴 Слушаю...`,t.disabled=!0,r.style.display=`none`;let s=setTimeout(()=>{try{a.stop()}catch{}r.style.display=`block`,r.innerHTML=`<span style="color:#F59E0B">⚠️ Не услышал ничего, попробуй ещё раз</span>`,o()},7e3);a.onresult=e=>{clearTimeout(s);let i=Array.from(e.results[0]).map(e=>e.transcript.toLowerCase().trim()),a=n.finnish.toLowerCase().trim(),c=i.some(e=>e===a||e.replace(/[.,!?-]/g,``)===a.replace(/[.,!?-]/g,``));r.style.display=`block`,c?(r.innerHTML=`<span style="color:#10B981">✅ Отлично! Правильно произнесено!</span>`,t.textContent=`🎤 Произнеси`):(r.innerHTML=`<span style="color:#EF4444">❌ Услышал: «${i[0]}»<br>Ожидал: «${n.finnish}»</span>`,o()),t.disabled=!1},a.onerror=e=>{clearTimeout(s),r.style.display=`block`,r.innerHTML=`<span style="color:#F59E0B">${e.error===`no-speech`?`⚠️ Ничего не услышал — говори громче!`:`⚠️ Не удалось распознать, попробуй ещё раз`}</span>`,o()},a.onend=()=>{clearTimeout(s),t.disabled&&o()},a.start()}),document.getElementById(`btn-hard`)?.addEventListener(`click`,()=>be(`hard`)),document.getElementById(`btn-ok`)?.addEventListener(`click`,()=>be(`learning`)),document.getElementById(`btn-know`)?.addEventListener(`click`,()=>be(`known`))}function be(e){let t=p(),n=P[N]._origIndex??N;if(y(t.activeProfile,F.id,n,e),N++,N>=P.length){xe();return}L=!1,ve()}function xe(){let e=p(),t=e.profiles[e.activeProfile]?.vocabulary[F.id]||{},n=Object.values(t).filter(e=>e.status===`known`).length;document.querySelector(`.vocab-container`)?.parentElement?.querySelector(`.vocab-container`),document.querySelector(`.vocab-page`).innerHTML=`
    ...
    <div class="complete-screen">
      ...
      <p style="color: #6B7280; margin-top: 8px">Знаю: <strong style="color: var(--success)">${n}</strong> из ${P.length} слов</p>
      <div style="background: ${I.bg}; padding: 14px 18px; border-radius: 10px; margin-top: 18px; max-width: 380px; font-size: 14px; line-height: 1.5">
      ...
      <div style="display:flex; gap:12px; margin-top:24px; justify-content:center">
        <button class="btn-complete" style="background: ${I.color}" id="btn-repeat">Ещё раз</button>
  ...
  `,document.getElementById(`btn-back-test`)?.addEventListener(`click`,()=>{P=F._allWords||P,document.querySelector(`.vocab-page`).innerHTML=pe(),he(F)}),Ee(e)}function Ee(e){let t=!1;document.querySelectorAll(`.test-option`).forEach(n=>{n.addEventListener(`click`,()=>{if(t)return;t=!0;let r=n.dataset.correct===`true`;r&&Ce++,document.querySelectorAll(`.test-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===n&&!r&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`test-feedback`);i.style.display=`flex`,i.innerHTML=r?`<div class="feedback-correct" style="border-color: ${I.color}">✓ Правильно!</div>
    ...
    <div class="complete-screen">
      ...
      <div style="display:flex; gap:12px; margin-top:24px; justify-content:center">
        <button class="btn-complete" style="background: ${I.color}" id="btn-retest">Ещё раз</button>
        ...
        <div class="mode-cards">
          <div class="mode-card" id="ex-start-sheet">
            ...
            <div class="mode-info">
              ...
              <div class="mode-desc">${z.length} упражнений · грамматика и лексика</div>
            </div>
          ...
          <div class="mode-card" style="opacity:0.45;pointer-events:none">
            <div class="mode-icon" style="background:${V.bg}">✍️</div>
            <div class="mode-info">
    ...
    <div class="ex-page">
      ...
      <div class="ex-progress-bar">
        <div class="ex-progress-fill" id="ex-progress-fill"
             style="width: ${Ne(0)}%; background: ${V.color}"></div>
      </div>
      <div class="ex-container" id="ex-container">
        ${Fe(z[0],0)}
      </div>
    </div>
  `}function Ne(e){return Math.round(e/z.length*100)}function Pe(e){return e.map(e=>({v:e,sort:Math.random()})).sort((e,t)=>e.sort-t.sort).map(({v:e})=>e)}function Fe(e,t){let n=e.type||`multiple_choice`,r=Oe[n]||n,i=[e.option_a,e.option_b,e.option_c,e.option_d].filter(Boolean),a=`abcd`.indexOf((e.correct||`a`).toLowerCase()),o=i[a]||i[0],s=n===`self_check`?i:Pe(i.map((e,t)=>({text:e,isCorrect:t===a})));return n===`self_check`?`
  ...
  `}function Ie(e){ke=e,V=j[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}`)}),document.getElementById(`ex-start-sheet`)?.addEventListener(`click`,()=>{B=0,Ae=!1,document.querySelector(`.ex-page`).outerHTML,document.querySelector(`#app`).innerHTML=Me(e),document.getElementById(`btn-back-ex`)?.addEventListener(`click`,()=>A(`/chapter/${e.id}/exercises`)),Le()}),document.getElementById(`ex-vocab-drills`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}/vocab-exercises`)})}function Le(){let e=z[B];e&&(Ae=!1,document.getElementById(`btn-show-answer`)?.addEventListener(`click`,()=>{document.getElementById(`answer-reveal`).style.display=`block`,document.getElementById(`btn-show-answer`).style.display=`none`}),document.querySelectorAll(`.self-btn`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.result,v(p().activeProfile,ke.id,B,e.dataset.result),Re()})}),document.querySelectorAll(`.ex-option`).forEach(t=>{t.addEventListener(`click`,()=>{if(Ae)return;Ae=!0;let n=t.dataset.correct===`true`,r=document.querySelector(`.ex-card`).dataset.correct;document.querySelectorAll(`.ex-option`).forEach(e=>{e.dataset.correct===`true`?e.classList.add(`correct`):e===t&&!n&&e.classList.add(`wrong`),e.disabled=!0});let i=document.getElementById(`ex-feedback`);i.style.display=`block`,i.innerHTML=n?`<div class="feedback-correct" style="border-color: ${V.color}">
           ...
           <button class="ex-next-btn" id="btn-next" style="background: ${V.color}">
             ${B+1<z.length?`Следующее →`:`Завершить 🎉`}
           </button>`,v(p().activeProfile,ke.id,B,n?`right`:`wrong`),document.getElementById(`btn-next`)?.addEventListener(`click`,Re)})}))}function Re(){if(B++,B>=z.length){ze();return}let e=document.getElementById(`ex-container`);e.innerHTML=Fe(z[B],B),document.getElementById(`ex-counter`).textContent=`${B+1} / ${z.length}`,document.getElementById(`ex-progress-fill`).style.width=`${Ne(B)}%`,Le()}function ze(){let e=document.getElementById(`ex-container`);e.innerHTML=`
    <div class="complete-screen">
      <div class="complete-emoji">🏆</div>
  ...
  `,document.getElementById(`btn-to-chapter-ex`)?.addEventListener(`click`,()=>{A(`/chapter/${ke.id}`)})}var Be={tervehtimiset:[{q:`Как поздороваться вечером`,a:`Iltaa`},{q:`Как сказать «Добро пожаловать»`,a:`Tervetuloa`},{q:`Как ответить на «Kiitos»`,a:`Ei kestä`},{q:`Как сказать «Ничего страшного»`,a:`Ei se mitään`},{q:`Как спросить «Как дела»`,a:`Mitä kuuluu`},{q:`Как сказать «Спокойной ночи»`,a:`Hyvää yötä`},{q:`Как сказать «До свидания» (официально)`,a:`Näkemiin`},{q:`Как сказать «Увидимся» (в разговоре)`,a:`Nähdään`},{q:`Как сказать «Пока пока» (разговорное)`,a:`Moi moi / Hei hei / Moikka`},{q:`Как попросить прощения`,a:`Anteeksi`},{q:`Как ответить на «Mitä kuuluu»`,a:`Ihan hyvää / Kiitos hyvää`}],tutustuminen:[{q:`Как сказать «Меня зовут Анна»`,a:`Mun nimi on Anna / Minun nimeni on Anna`},{q:`Как спросить «Откуда ты» по-разговорному`,a:`Mistä oot kotoisin`},{q:`Как сказать «Я из Финляндии»`,a:`Olen Suomesta`},{q:`Как сказать «Мне 28 лет»`,a:`Olen 28-vuotias`},{q:`Как сказать «Не понимаю»`,a:`En ymmärrä`},{q:`Как попросить говорить медленнее`,a:`Voitko puhua hitaammin`},{q:`Как сказать «Приятно познакомиться»`,a:`Hauska tutustua`},{q:`Как спросить «Говоришь по-английски» (вопрос)`,a:`Puhutko englantia`},{q:`Как спросить «Как тебя зовут» по-разговорному (вопрос)`,a:`Mikä sun nimi on`},{q:`Как сказать «Я из России»`,a:`Olen Venäjältä`},{q:`Как сказать «Мне нужна помощь»`,a:`Tarvitsen apua`},{q:`Как спросить «Тебе нужна помощь?» (вопрос)`,a:`Tarvitsetko apua`},{q:`Как спросить «Где ты живёшь?» (вопрос)`,a:`Missä asut`},{q:`Как спросить «Что случилось?» (вопрос)`,a:`Mitä on tapahtunut / Mitä tapahtui`},{q:`Как спросить «Как это пишется?» (вопрос)`,a:`Miten tämä kirjoitetaan`}],lauserakenne:[{q:`Как спросить «Что это» (вопрос)`,a:`Mikä tämä on`},{q:`Как сказать «Это книга»`,a:`Se on kirja`},{q:`Как сказать «Это хороший автобус»`,a:`Se on hyvä bussi`},{q:`Как сказать «Эта машина плохая»`,a:`Tämä auto on huono`},{q:`Как сказать «Это отель»`,a:`Se on hotelli`},{q:`Как спросить «Это хорошая книга?» (вопрос)`,a:`Onko se hyvä kirja`},{q:`Как спросить «Кто это?» (вопрос)`,a:`Kuka tämä on`}],persoonapronominit:[{q:`Как сказать «Вы финны»`,a:`Te olette suomalaisia / Te ootte suomalaisia`},{q:`Как сказать «Я студентка»`,a:`Minä olen opiskelija / Mä oon opiskelija`},{q:`Как сказать «Он дома»`,a:`Hän on kotona / Se on kotona`},{q:`Как сказать «Они здесь»`,a:`He ovat täällä / Ne on täällä`},{q:`Как сказать «Ты готова»`,a:`Sinä olet valmis / Sä oot valmis`},{q:`Как спросить «Ты готова?» (вопрос)`,a:`Oletko sinä valmis / Ootko sä valmis`},{q:`Как сказать «Мы учимся»`,a:`Me opiskelemme / Me opiskellaan`}],verbit:[{q:`Как сказать «Я живу в Хельсинки»`,a:`Asun Helsingissä / Mä asun Helsingissä`},{q:`Как спросить «Где ты живёшь?» (вопрос)`,a:`Missä asut`},{q:`Как сказать «Она живёт в Тампере»`,a:`Hän asuu Tampereella / Se asuu Tampereella`},{q:`Как сказать «Мы живём в Финляндии»`,a:`Me asumme Suomessa / Me asutaan Suomessa`},{q:`Как сказать «Я говорю по-фински»`,a:`Puhun suomea / Mä puhun suomea`},{q:`Как спросить «Ты говоришь по-русски?» (вопрос)`,a:`Puhutko venäjää / Puhutko sä venäjää`},{q:`Как сказать «Он говорит по-английски»`,a:`Hän puhuu englantia / Se puhuu englantia`},{q:`Как сказать «Мы говорим по-фински»`,a:`Me puhumme suomea / Me puhutaan suomea`}],"verbi olla":[{q:`Скажи «Я не студентка»`,a:`Minä en ole opiskelija / Mä en oo opiskelija`},{q:`Скажи «Она не дома»`,a:`Hän ei ole kotona / Se ei oo kotona`},{q:`Скажи «Мы не готовы»`,a:`Me emme ole valmiita / Me ei olla valmiita`},{q:`Скажи «Они финны»`,a:`He ovat suomalaisia / Ne on suomalaisia`},{q:`Как спросить «Ты финн?» (вопрос)`,a:`Oletko sinä suomalainen / Ootko sä suomalainen`},{q:`Как спросить «Она дома?» (вопрос)`,a:`Onko hän kotona / Onko se kotona`},{q:`Как сказать «Я в кафе»`,a:`Minä olen kahvilassa / Mä oon kahvilassa`}],vokaaliharmonia:[{q:`В школе (koulu)?`,a:`koulussa`},{q:`На столе (pöytä)?`,a:`pöydällä`},{q:`В городе (kaupunki)?`,a:`kaupungissa`},{q:`На работе (työ)?`,a:`työssä`},{q:`В Турку (Turku)?`,a:`Turussa`},{q:`В лесу (metsä)?`,a:`metsässä`},{q:`В машине (auto)?`,a:`autossa`},{q:`На улице (katu)?`,a:`kadulla`}],numerot:[{q:`Как сказать «13»?`,a:`kolmetoista`},{q:`Как сказать «17»?`,a:`seitsemäntoista`},{q:`Как сказать «30»?`,a:`kolmekymmentä`},{q:`Как сказать «Мне 28 лет»?`,a:`Olen 28-vuotias / Olen kaksikymmentäkahdeksan`},{q:`Как сказать «Кофе стоит 4 евро»?`,a:`Kahvi maksaa neljä euroa`},{q:`Как спросить «Сколько стоит»?`,a:`Paljonko maksaa`},{q:`Как сказать «Сейчас 3 часа»?`,a:`Kello on kolme`}],viikonpäivät:[{q:`Как сказать «В четверг»?`,a:`torstaina`},{q:`Как сказать «В воскресенье»?`,a:`sunnuntaina`},{q:`Как сказать «Сегодня среда»?`,a:`Tänään on keskiviikko`},{q:`Как сказать «Вчера была пятница»?`,a:`Eilen oli perjantai`},{q:`Как сказать «Увидимся в понедельник»?`,a:`Nähdään maanantaina`},{q:`Как спросить «Какой сегодня день»?`,a:`Mikä päivä tänään on`},{q:`Как сказать «Завтра суббота»?`,a:`Huomenna on lauantai`}]};function Ve(e){let t=Object.keys(Be).find(t=>e.toLowerCase().includes(t));return t?[...Be[t]].sort(()=>Math.random()-.5):[]}var He=0;function Ue(e){return e.replace(/<[^>]+>/g,``).trim().toLowerCase().replace(/[.,!?;:«»""''()\-]/g,``).replace(/\s+/g,` `).trim()}function We(e,t){for(let n=0;n<t.length;n++){if(!e[n])return`пропущено слово «${t[n]}»`;if(e[n]!==t[n])return`«${e[n]}» → должно быть «${t[n]}»`}return e.length>t.length?`лишнее слово «${e[t.length]}»`:null}function Ge(e,t){return e.replace(/<\/details>/g,`</details><br>`).replace(/<br>\s*([^<\n]{4,}?)\s*<details><summary>[^<]*<\/summary>([\s\S]*?)<\/details>/g,(e,n,r)=>{let i=`gi-${t}-${He++}`,a=r.replace(/<[^>]+>/g,``).replace(/"/g,`&quot;`).trim();return`
        ...
        </div>`})}var Ke=null,H=[];function qe(e,t){if(Ke=j[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},H=t.filter(t=>t.Chapter===e.id).sort((e,t)=>(parseInt(e.Block)||0)-(parseInt(t.Block)||0)),!H.length)return`
    ...
    <div class="grammar-page">
      ...
      <div class="grammar-header">
        <h2 style="color: ${Ke.color}; margin: 0 0 8px">Грамматика</h2>
        <div class="progress-bar" style="height: 8px; margin-bottom: 24px">
          <div class="progress-fill" style="width: ${Math.round(a/H.length*100)}%; background: ${Ke.color}; height: 100%"></div>
        </div>
      </div>
        ...
        ${H.map((e,t)=>{let n=`block-${t}`,r=i[n]===!0;return`
            <div class="grammar-block ${r?`completed`:``}" data-block-id="${n}">
              ...
              <div class="grammar-block-content" id="content-${n}" style="display: none; padding: 16px; background: white; border-top: 1px solid #E5E7EB">
                <div class="grammar-text">${Ge(e.Content||``,n)}</div>
                ${e.Examples?`
  ...
  `}function Ze(e){Ye=e,U=j[e.id]||{color:`#7C3AED`,bg:`#EDE7FB`},document.getElementById(`btn-back-vex`)?.addEventListener(`click`,()=>{A(`/chapter/${e.id}/exercises`)}),document.getElementById(`vex-input`)?.addEventListener(`click`,()=>it()),document.getElementById(`vex-match`)?.addEventListener(`click`,()=>lt()),document.getElementById(`vex-drag`)?.addEventListener(`click`,()=>pt()),document.getElementById(`vex-audio`)?.addEventListener(`click`,()=>ht())}function Qe(){return document.querySelector(`.vocab-ex-page`)}function $e(e,t,n){return`
    <header class="header">
    ...
    </div>`}function et(){document.getElementById(`btn-back-vex-mode`)?.addEventListener(`click`,()=>{Qe().innerHTML=tt(),Ze(Ye)})}function tt(){return document.querySelector(`.vocab-ex-page`)?.outerHTML||``}function nt(e,t,n){let r=Math.round(t/n*100),i=r>=80?`🏆`:r>=60?`👍`:`💪`;Qe().innerHTML=`
    <header class="header">
    ...
    </div>`,document.getElementById(`btn-complete-back`)?.addEventListener(`click`,rt),document.getElementById(`btn-to-ex`)?.addEventListener(`click`,rt),document.getElementById(`btn-again`)?.addEventListener(`click`,()=>{G===`input`?it():G===`match`?lt():G===`drag`?pt():G===`audio`&&ht()})}function rt(){A(`/chapter/${Ye.id}/exercises`)}function it(){G=`input`,K=0,J=0,Y=X(W).slice(0,Math.min(15,W.length)),q=Y.length,at()}function at(){if(J>=Y.length){nt(`Ввод`,K,q);return}let e=Y[J];Qe().innerHTML=`
    ${$e(`Ввод перевода`,J+1,q)}
    ...
    </div>`,et();let t=document.getElementById(`input-answer`);t?.focus(),t?.addEventListener(`keydown`,t=>{t.key===`Enter`&&ot(e)}),document.getElementById(`btn-check-input`)?.addEventListener(`click`,()=>ot(e))}function ot(e){let t=document.getElementById(`input-answer`)?.value.trim().toLowerCase()||``;if(!t)return;let n=e.russian.toLowerCase().split(/[,;/()]/).map(e=>e.trim()).filter(Boolean).some(e=>t.includes(e)||e.includes(t));n&&K++;let r=document.getElementById(`input-feedback`);r.style.display=`block`,r.innerHTML=n?`<span style="color:var(--success);font-weight:600">✅ Правильно!</span>`:`<span style="color:var(--error)">❌ Правильно: <strong>${e.russian}</strong></span>`,document.getElementById(`btn-check-input`).textContent=`Дальше →`,document.getElementById(`btn-check-input`).onclick=()=>{J++,at()},document.getElementById(`input-answer`).disabled=!0}var Z=null,st=[],ct=[];function lt(){G=`match`,K=0,Z=null,ct=[],Y=X(W).slice(0,Math.min(8,W.length)),q=Y.length,st=Y,ut()}function ut(){let e=X(st.map(e=>({id:e.finnish,text:e.finnish,type:`fi`}))),t=X(st.map(e=>({id:e.finnish,text:e.russian,type:`ru`})));Qe().innerHTML=`
    ${$e(`Мэтч`,ct.length,q)}
    <div class="ex-container">
      <div class="ex-card">
        ...
        <div class="match-grid">
          <div class="match-col" id="col-fi">
            ${e.map(e=>`
              <button class="match-btn ${ct.includes(e.id)?`match-done`:``}"
    ...
    </div>`,et(),document.querySelectorAll(`.match-btn:not(.match-done)`).forEach(e=>{e.addEventListener(`click`,()=>dt(e))})}function dt(e){let t=e.dataset.id,n=e.dataset.type;if(!Z){Z={id:t,type:n,btn:e},e.classList.add(`match-selected`);return}if(Z.btn===e){e.classList.remove(`match-selected`),Z=null;return}Z.id===t&&Z.type!==n?(K++,ct.push(t),Z.btn.classList.remove(`match-selected`),Z.btn.classList.add(`match-correct`),e.classList.add(`match-correct`),Z=null,ct.length===q&&setTimeout(()=>nt(`Мэтч`,K,q),600)):(Z.btn.classList.remove(`match-selected`),Z.btn.classList.add(`match-wrong`),e.classList.add(`match-wrong`),setTimeout(()=>{Z?.btn.classList.remove(`match-wrong`),e.classList.remove(`match-wrong`),Z=null},700))}var ft=[],Q={};function pt(){G=`drag`,K=0,Q={},Y=X(W).slice(0,Math.min(6,W.length)),q=Y.length,ft=Y,mt()}function mt(){let e=[...ft].sort(()=>Math.random()-.5),t=X([...ft]);Qe().innerHTML=`
    ${$e(`Drag & Drop`,Object.keys(Q).length,q)}
    <div class="ex-container">
      <div class="ex-card">
          ...
          ${e.map(e=>`
            <div class="drag-row">
              <div class="drag-target ${Q[e.finnish]===void 0?``:Q[e.finnish]===e.finnish?`drag-correct`:`drag-wrong`}"
                ...
                ${Q[e.finnish]===void 0?`<span class="drag-placeholder">Перетащи сюда</span>`:`<span class="drag-placed">${ft.find(t=>t.finnish===Q[e.finnish])?.finnish||``}</span>`}
              </div>
    ...
    </div>`,et(),window._handleDragStart=(e,t)=>{e.dataTransfer.setData(`text/plain`,t)},window._handleDrop=(e,t)=>{let n=e.dataTransfer.getData(`text/plain`);Q[t]=n,n===t&&K++,mt()};let n=null;document.querySelectorAll(`.drag-chip`).forEach(e=>{e.addEventListener(`click`,()=>{if(document.querySelectorAll(`.drag-chip`).forEach(e=>e.classList.remove(`chip-selected`)),n===e.dataset.word){n=null;return}n=e.dataset.word,e.classList.add(`chip-selected`)})}),document.querySelectorAll(`.drag-target`).forEach(e=>{e.addEventListener(`click`,()=>{if(!n)return;let t=e.dataset.target;Q[t]=n,n===t&&K++,n=null,mt()})}),document.getElementById(`btn-drag-done`)?.addEventListener(`click`,()=>{nt(`Drag & Drop`,K,q)})}function ht(){G=`audio`,K=0,J=0,Y=X(W).slice(0,Math.min(10,W.length)),q=Y.length,gt()}function gt(){if(J>=Y.length){nt(`Произношение`,K,q);return}let e=Y[J];Qe().innerHTML=`
    ${$e(`Произношение`,J+1,q)}
    <div class="ex-container">
    ...
    </div>`,et();function t(){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e.finnish);t.lang=`fi-FI`,t.rate=.85,window.speechSynthesis.speak(t)}document.getElementById(`btn-speak`)?.addEventListener(`click`,t),t(),document.getElementById(`btn-mic`)?.addEventListener(`click`,()=>{let t=document.getElementById(`btn-mic`),n=document.getElementById(`mic-result`),r=window.SpeechRecognition||window.webkitSpeechRecognition;if(!r){n.style.display=`block`,n.innerHTML=`<span style="color:#F59E0B">⚠️ Браузер не поддерживает распознавание</span>`;return}let i=new r;i.lang=`fi-FI`,i.maxAlternatives=5,t.textContent=`🔴 Слушаю...`,t.disabled=!0,n.style.display=`none`;let a=setTimeout(()=>{try{i.stop()}catch{}n.style.display=`block`,n.innerHTML=`<span style="color:#F59E0B">⚠️ Ничего не услышал</span>`,t.textContent=`🎤 Попробуй ещё`,t.disabled=!1},7e3);i.onresult=r=>{clearTimeout(a);let i=Array.from(r.results[0]).map(e=>e.transcript.toLowerCase().trim()),o=e.finnish.toLowerCase().trim(),s=i.some(e=>e.replace(/[.,!?]/g,``)===o.replace(/[.,!?]/g,``));s&&K++,n.style.display=`block`,n.innerHTML=s?`<span style="color:var(--success)">✅ Отлично!</span>`:`<span style="color:var(--error)">❌ Услышал: «${i[0]}»</span>`,t.textContent=s?`🎤 Произнеси`:`🎤 Попробуй ещё`,t.disabled=!1},i.onerror=()=>{clearTimeout(a),n.style.display=`block`,n.innerHTML=`<span style="color:#F59E0B">⚠️ Попробуй ещё раз</span>`,t.textContent=`🎤 Попробуй ещё`,t.disabled=!1},i.onend=()=>{clearTimeout(a),t.disabled&&(t.disabled=!1,t.textContent=`🎤 Попробуй ещё`)},i.start()}),document.getElementById(`btn-next-audio`)?.addEventListener(`click`,()=>{J++,gt()})}var _t=[{id:`A0–A1`,label:`A0–A1`,color:`#7C3AED`,bg:`#EDE7FB`,chapters:[`ch1`,`ch2`,`ch3`,`ch4`,`ch5`]},{id:`A1–A2`,label:`A1–A2`,color:`#EC4899`,bg:`#FAE9F2`,chapters:[`ch6`,`ch7`,`ch8`,`ch9`,`ch10`]},{id:`A2–B1`,label:`A2–B1`,color:`#F59E0B`,bg:`#FEEEDB`,chapters:[`ch11`,`ch12`,`ch13`,`ch14`,`ch15`]},{id:`B1–B2`,label:`B1–B2`,color:`#10B981`,bg:`#E8F7EE`,chapters:[`ch16`,`ch17`,`ch18`,`ch19`,`ch20`]}];function vt(e){let t=p().profiles[e];for(let e=0;e<_t.length;e++){let n=_t[e],r=_t[e+1],i=n.chapters.filter(e=>{let n=t.vocabulary[e]||{},r=t.exercises[e]||{};return Object.values(n).filter(e=>e.seen).length>0||Object.values(r).filter(e=>e.completed).length>0}).length,a=n.chapters.length,o=Math.round(i/a*100);if(o<100)return{current:n,next:r,completed:i,total:a,pct:o}}let n=_t[_t.length-1];return{current:n,next:null,completed:n.chapters.length,total:n.chapters.length,pct:100}}function yt(e){let t=p().profiles[e],{totalWords:n,totalExercises:r,totalChapters:i,streak:a,activity:o}=T(e),{current:s,next:c,completed:l,total:u,pct:d}=vt(e);return`
  ...
  `}function xt(e){let t=[],n=new Date;for(let r=7;r>=0;r--){let i=0,a=``;for(let t=0;t<7;t++){let o=new Date(n);o.setDate(n.getDate()-r*7-t),e[o.toISOString().slice(0,10)]&&i++,t===0&&r%2==0&&(a=`${o.getDate()}.${String(o.getMonth()+1).padStart(2,`0`)}`)}t.push({count:i,label:a})}let r=Math.max(...t.map(e=>e.count),1);Math.round(3/r*80);let i=t.map((e,n)=>{let i=e.count>0?Math.max(Math.round(e.count/r*80),8):4,a=n===t.length-1,o=e.count===0;return`
        ...
        <div class="profile-switcher" style="position:relative">
          ...
          <div class="profile-dropdown" id="profile-dropdown" style="display:none">
            ...
            <button class="profile-dropdown-item" id="btn-profile-settings">
              <span>⚙️</span><span>Настройки профиля</span>
            </button>
  ...
  `}function $(e){document.querySelector(`#app`).innerHTML=e}function Mt(){document.getElementById(`btn-active-profile`)?.addEventListener(`click`,e=>{e.stopPropagation();let t=document.getElementById(`profile-dropdown`);t&&(t.style.display=t.style.display===`none`?`block`:`none`)}),document.addEventListener(`click`,()=>{let e=document.getElementById(`profile-dropdown`);e&&(e.style.display=`none`)},{once:!1}),document.querySelectorAll(`.profile-dropdown-item[data-profile]`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.profile,r=p().profiles[n];r?.pin?Vt(n,r.name):(_(n),Pt())})}),document.querySelectorAll(`.chapter-card`).forEach(e=>{e.addEventListener(`click`,()=>{A(`/chapter/${e.dataset.chapter}`)})}),document.querySelectorAll(`.level-header-toggle`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.levelTarget,n=document.getElementById(`level-${t}`),r=e.querySelector(`.level-chevron`);if(!n)return;let i=!n.classList.contains(`level-collapsed`);n.classList.toggle(`level-collapsed`,i),r?.classList.toggle(`open`,!i)})}),document.getElementById(`btn-add-profile`)?.addEventListener(`click`,zt),document.getElementById(`btn-start-learning`)?.addEventListener(`click`,zt),document.getElementById(`btn-profile-settings`)?.addEventListener(`click`,Bt)}var Nt=Ct.map(e=>({...e,...j[e.id]}));function Pt(){$(kt(p(),Nt)),Mt()}var Ft={chapters:[],vocabulary:[],exercises:[]};async function It(){document.querySelector(`#app`).innerHTML=`<div class="loading">Загружаем финский... 🇫🇮</div>`;try{Ft=await ne(),Ft.chapters?.length>0&&(Nt=Ft.chapters.map(e=>({...e,...j[e.id]})))}catch{console.log(`Sheets недоступен, используем demo данные`)}Lt(),re(Lt)}function Lt(){let e=k(),t=p();if(e.page===`dashboard`||!e.page){Pt();return}if(e.page===`profile`){$(yt(e.profileId)),St();return}let n=Nt.find(t=>t.id===e.chapterId);if(!n){Pt();return}let r=Ft.vocabulary.filter(t=>t.chapter_id===e.chapterId),i=Ft.exercises.filter(t=>t.chapter_id===e.chapterId),a=Ft.grammar||[];if(e.section===`vocabulary`){$(me(n,r)),he(n);return}if(e.section===`exercises`){$(je(n,i)),Ie(n);return}if(e.section===`grammar`){$(qe(n,a)),Je(n);return}if(e.section===`vocab-exercises`){$(Xe(n,r)),Ze(n);return}$(M(n,r,i,t,a.filter(t=>t.Chapter===e.chapterId))),oe(e.chapterId,r,t.activeProfile,i)}It();var Rt=[`🦊`,`🐱`,`🐻`,`🐼`,`🦁`,`🐸`,`🐧`,`🦋`,`🌸`,`⭐`,`🎯`,`🚀`];function zt(){let e=document.createElement(`div`);e.id=`add-profile-modal`,e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e);let t=Rt[0];e.querySelector(`.avatar-option[data-emoji="${t}"]`)?.classList.add(`selected`),e.querySelectorAll(`.avatar-option`).forEach(n=>{n.addEventListener(`click`,()=>{e.querySelectorAll(`.avatar-option`).forEach(e=>e.classList.remove(`selected`)),n.classList.add(`selected`),t=n.dataset.emoji})}),document.getElementById(`btn-cancel-modal`)?.addEventListener(`click`,()=>e.remove()),document.getElementById(`modal-overlay`)?.addEventListener(`click`,t=>{t.target.id===`modal-overlay`&&e.remove()}),document.getElementById(`btn-save-profile`)?.addEventListener(`click`,()=>{let n=document.getElementById(`profile-name-input`)?.value.trim();if(!n){document.getElementById(`profile-name-input`).style.borderColor=`var(--error)`;return}let r=document.getElementById(`profile-pin-input`)?.value.trim(),i=p(),a=`user_`+Date.now();i.profiles[a]={name:n,avatarEmoji:t,pin:r||null,chapters:{},vocabulary:{},exercises:{},activity:{}},h(i),_(a),e.remove(),Pt()})}function Bt(){let e=p(),t=e.profiles[e.activeProfile],n=!!t.pin,r=document.createElement(`div`);r.innerHTML=`
    <div class="modal-overlay" id="settings-overlay">
      <div class="modal-box">
        <h3 style="margin-bottom:16px">⚙️ Настройки профиля</h3>
        <div style="font-size:14px;font-weight:600;margin-bottom:8px">${t.name}</div>
        <div style="font-size:13px;color:#6B7280;margin-bottom:4px">
          ${n?`🔒 PIN установлен. Введи новый чтобы изменить, или оставь пустым чтобы убрать:`:`🔓 PIN не установлен. Добавь для защиты профиля:`}
        </div>
